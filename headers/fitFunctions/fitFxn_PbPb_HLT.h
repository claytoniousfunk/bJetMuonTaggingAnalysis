...
void loadFitFxn_PbPb_HLT(){
  ...
  fitFxn_PbPb_HLT_C4 = new TF1("fitFxn_PbPb_HLT_C4","[0] - ([0] - [1])*exp(-[2]*x)",15,100);
  fitFxn_PbPb_HLT_C3 = new TF1("fitFxn_PbPb_HLT_C3","[0] - ([0] - [1])*exp(-[2]*x)",15,100);
  fitFxn_PbPb_HLT_C2 = new TF1("fitFxn_PbPb_HLT_C2","[0] - ([0] - [1])*exp(-[2]*x)",15,100);
  fitFxn_PbPb_HLT_C1 = new TF1("fitFxn_PbPb_HLT_C1","[0] - ([0] - [1])*exp(-[2]*x)",15,100);
