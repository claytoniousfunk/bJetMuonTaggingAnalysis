...
void newFractionCalculation_MC(){
  ...
  TH2D *H_jetPt_pp, *H_jetPt_C4, *H_jetPt_C3, *H_jetPt_C2, *H_jetPt_C1;
  ...
  TH1D *h_bbarJetPt_muTag_muTrig_pp, *h_bbarJetPt_muTag_muTrig_C4, *h_bbarJetPt_muTag_muTrig_C3, *h_bbarJetPt_muTag_muTrig_C2, *h_bbarJetPt_muTag_muTrig_C1;
...
v  file_PH_DiJet->GetObject("h_inclRecoJetPt_inclRecoMuonTag_triggerOn_flavor_C4",H_jetPt_muTag_muTrig_C4);
  ...
  TH1D *binFinder = (TH1D*) H_jetPt_muTag_muTrig_pp->ProjectionY("binFinder");
  double ss = 0.01;
  
  h_jetPt_muTag_muTrig_pp = (TH1D*) H_jetPt_muTag_muTrig_pp->ProjectionX("h_jetPt_muTag_muTrig_pp",binFinder->FindBin(-5+ss),binFinder->FindBin(22-ss));
  h_jetPt_muTag_muTrig_C4 = (TH1D*) H_jetPt_muTag_muTrig_C4->ProjectionX("h_jetPt_muTag_muTrig_C4",binFinder->FindBin(-5+ss),binFinder->FindBin(22-ss));
  h_jetPt_muTag_muTrig_C3 = (TH1D*) H_jetPt_muTag_muTrig_C3->ProjectionX("h_jetPt_muTag_muTrig_C3",binFinder->FindBin(-5+ss),binFinder->FindBin(22-ss));
  h_jetPt_muTag_muTrig_C2 = (TH1D*) H_jetPt_muTag_muTrig_C2->ProjectionX("h_jetPt_muTag_muTrig_C2",binFinder->FindBin(-5+ss),binFinder->FindBin(22-ss));
  h_jetPt_muTag_muTrig_C1 = (TH1D*) H_jetPt_muTag_muTrig_C1->ProjectionX("h_jetPt_muTag_muTrig_C1",binFinder->FindBin(-5+ss),binFinder->FindBin(22-ss));

  h_bbarJetPt_muTag_muTrig_pp = (TH1D*) H_jetPt_muTag_muTrig_pp->ProjectionX("h_bbarJetPt_muTag_muTrig_pp",binFinder->FindBin(-5+ss),binFinder->FindBin(-4-ss));
  h_bbarJetPt_muTag_muTrig_C4 = (TH1D*) H_jetPt_muTag_muTrig_C4->ProjectionX("h_bbarJetPt_muTag_muTrig_C4",binFinder->FindBin(-5+ss),binFinder->FindBin(-4-ss));
  h_bbarJetPt_muTag_muTrig_C3 = (TH1D*) H_jetPt_muTag_muTrig_C3->ProjectionX("h_bbarJetPt_muTag_muTrig_C3",binFinder->FindBin(-5+ss),binFinder->FindBin(-4-ss));
  h_bbarJetPt_muTag_muTrig_C2 = (TH1D*) H_jetPt_muTag_muTrig_C2->ProjectionX("h_bbarJetPt_muTag_muTrig_C2",binFinder->FindBin(-5+ss),binFinder->FindBin(-4-ss));
  h_bbarJetPt_muTag_muTrig_C1 = (TH1D*) H_jetPt_muTag_muTrig_C1->ProjectionX("h_bbarJetPt_muTag_muTrig_C1",binFinder->FindBin(-5+ss),binFinder->FindBin(-4-ss));

  h_bJetPt_muTag_muTrig_pp = (TH1D*) H_jetPt_muTag_muTrig_pp->ProjectionX("h_bJetPt_muTag_muTrig_pp",binFinder->FindBin(5+ss),binFinder->FindBin(6-ss));
  h_bJetPt_muTag_muTrig_C4 = (TH1D*) H_jetPt_muTag_muTrig_C4->ProjectionX("h_bJetPt_muTag_muTrig_C4",binFinder->FindBin(5+ss),binFinder->FindBin(6-ss));
  h_bJetPt_muTag_muTrig_C3 = (TH1D*) H_jetPt_muTag_muTrig_C3->ProjectionX("h_bJetPt_muTag_muTrig_C3",binFinder->FindBin(5+ss),binFinder->FindBin(6-ss));
  h_bJetPt_muTag_muTrig_C2 = (TH1D*) H_jetPt_muTag_muTrig_C2->ProjectionX("h_bJetPt_muTag_muTrig_C2",binFinder->FindBin(5+ss),binFinder->FindBin(6-ss));
  h_bJetPt_muTag_muTrig_C1 = (TH1D*) H_jetPt_muTag_muTrig_C1->ProjectionX("h_bJetPt_muTag_muTrig_C1",binFinder->FindBin(5+ss),binFinder->FindBin(6-ss));

  h_bGSJetPt_muTag_muTrig_pp = (TH1D*) H_jetPt_muTag_muTrig_pp->ProjectionX("h_bGSJetPt_muTag_muTrig_pp",binFinder->FindBin(17+ss),binFinder->FindBin(18-ss));
  h_bGSJetPt_muTag_muTrig_C4 = (TH1D*) H_jetPt_muTag_muTrig_C4->ProjectionX("h_bGSJetPt_muTag_muTrig_C4",binFinder->FindBin(17+ss),binFinder->FindBin(18-ss));
  h_bGSJetPt_muTag_muTrig_C3 = (TH1D*) H_jetPt_muTag_muTrig_C3->ProjectionX("h_bGSJetPt_muTag_muTrig_C3",binFinder->FindBin(17+ss),binFinder->FindBin(18-ss));
  h_bGSJetPt_muTag_muTrig_C2 = (TH1D*) H_jetPt_muTag_muTrig_C2->ProjectionX("h_bGSJetPt_muTag_muTrig_C2",binFinder->FindBin(17+ss),binFinder->FindBin(18-ss));
  h_bGSJetPt_muTag_muTrig_C1 = (TH1D*) H_jetPt_muTag_muTrig_C1->ProjectionX("h_bGSJetPt_muTag_muTrig_C1",binFinder->FindBin(17+ss),binFinder->FindBin(18-ss));

  h_bJetPt_muTag_muTrig_pp->Add(h_bbarJetPt_muTag_muTrig_pp);
  h_bJetPt_muTag_muTrig_pp->Add(h_bGSJetPt_muTag_muTrig_pp);

  h_bJetPt_muTag_muTrig_C4->Add(h_bbarJetPt_muTag_muTrig_C4);
  h_bJetPt_muTag_muTrig_C4->Add(h_bGSJetPt_muTag_muTrig_C4);

  h_bJetPt_muTag_muTrig_C3->Add(h_bbarJetPt_muTag_muTrig_C3);
  h_bJetPt_muTag_muTrig_C3->Add(h_bGSJetPt_muTag_muTrig_C3);

  h_bJetPt_muTag_muTrig_C2->Add(h_bbarJetPt_muTag_muTrig_C2);
  h_bJetPt_muTag_muTrig_C2->Add(h_bGSJetPt_muTag_muTrig_C2);
  ...
  file_PH_DiJet->GetObject("h_inclRecoJetPt_flavor_C4",H_jetPt_C4);
  file_PH_DiJet->GetObject("h_inclRecoJetPt_flavor_C3",H_jetPt_C3);
  file_PH_DiJet->GetObject("h_inclRecoJetPt_flavor_C2",H_jetPt_C2);
  file_PH_DiJet->GetObject("h_inclRecoJetPt_flavor_C1",H_jetPt_C1);

  h_jetPt_pp = (TH1D*) H_jetPt_pp->ProjectionX("h_jetPt_pp",binFinder->FindBin(-5+ss),binFinder->FindBin(22-ss));
  h_jetPt_C4 = (TH1D*) H_jetPt_C4->ProjectionX("h_jetPt_C4",binFinder->FindBin(-5+ss),binFinder->FindBin(22-ss));
  h_jetPt_C3 = (TH1D*) H_jetPt_C3->ProjectionX("h_jetPt_C3",binFinder->FindBin(-5+ss),binFinder->FindBin(22-ss));
  ...
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_triggerOn_C4",getEventNumber_muTag_muTrig_C4);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_triggerOn_C3",getEventNumber_muTag_muTrig_C3);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_triggerOn_C2",getEventNumber_muTag_muTrig_C2);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_triggerOn_C1",getEventNumber_muTag_muTrig_C1);

  file_PY_DiJet->GetObject("h_vz_inclRecoMuonTag",getEventNumber_muTag_pp_SingleMuon);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_C4",getEventNumber_muTag_C4_SingleMuon);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_C3",getEventNumber_muTag_C3_SingleMuon);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_C2",getEventNumber_muTag_C2_SingleMuon);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_C1",getEventNumber_muTag_C1_SingleMuon);

  file_PY_DiJet->GetObject("h_vz_inclRecoMuonTag",getEventNumber_muTag_pp_DiJet);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_C4",getEventNumber_muTag_C4_DiJet);
  file_PH_DiJet->GetObject("h_vz_inclRecoMuonTag_C3",getEventNumber_muTag_C3_DiJet);
  ...
  file_PH_DiJet->GetObject("h_hiBin",getEventNumber_jet_C1_MinBias);

  file_PY_DiJet->GetObject("h_vz",getEventNumber_pp_MinBias);
  file_PH_DiJet->GetObject("h_vz_C4",getEventNumber_C4_MinBias);
  file_PH_DiJet->GetObject("h_vz_C3",getEventNumber_C3_MinBias);
  file_PH_DiJet->GetObject("h_vz_C2",getEventNumber_C2_MinBias);
  file_PH_DiJet->GetObject("h_vz_C1",getEventNumber_C1_MinBias);
  ...
  h_bJetPt_muTag_muTrig_C2 = (TH1D*) h_bJetPt_muTag_muTrig_C2->Rebin(N_edge-1,"h_bJetPt_muTag_muTrig_C2",newAxis);
  divideByBinwidth(h_bJetPt_muTag_muTrig_C2);

  h_bJetPt_muTag_muTrig_C1 = (TH1D*) h_bJetPt_muTag_muTrig_C1->Rebin(N_edge-1,"h_bJetPt_muTag_muTrig_C1",newAxis);
  divideByBinwidth(h_bJetPt_muTag_muTrig_C1);
  ...
  // h_bJetPt_muTag_muTrig_C2->Scale(1./N_evt_C2_MinBias);
  ...
  h_bJetPt_muTag_muTrig_pp->GetYaxis()->SetTitle("1/#it{N}^{#it{b}-jet}_{#mu-tag,#mu-trig,tot} d#it{N}^{#it{b}-jet}_{#mu-tag,#mu-trig}/d#it{p}_{T} [GeV^{-1}]");
  ...
  canv_muTag_muTrig->SaveAs("./figures/spectra_bJet_muTag_muTrig.pdf");
