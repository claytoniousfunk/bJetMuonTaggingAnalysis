...
void muonTriggerClosure(){
  ...
  TFile *f_bJetMuRecoCorr = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/correctionFactors/correctionFactors_pp.root");
  ...
  f_genMuTagged->GetObject("h_inclRecoJetPt_inclRecoMuonTag_flavor",H_bJets_genMuTagged);
  f_recoMuTagged->GetObject("h_inclRecoJetPt_inclRecoMuonTag_triggerOn_flavor",H_bJets_recoMuTagged);
  ...
  f_bJetMuRecoCorr->GetObject("corrFactor_3_pp",h_bJetMuRecoCorr);
  ...
  h_bJets_recoMuTagged_withCorr->Scale(1./0.9414);
