...
TH1D *corrFactor_1_pp, *corrFactor_2_pp, *corrFactor_3_pp, *corrFactor_4_pp;
TH1D *corrFactor_1_C3, *corrFactor_2_C3, *corrFactor_3_C3, *corrFactor_4_C3;
TH1D *corrFactor_1_C2, *corrFactor_2_C2, *corrFactor_3_C2, *corrFactor_4_C2;
TH1D *corrFactor_1_C1, *corrFactor_2_C1, *corrFactor_3_C1, *corrFactor_4_C1;
// shorthand names
TH1D *a0, *a1, *a2, *a3;
TH1D *b0, *b1, *b2, *b3;
TH1D *c0, *c1, *c2, *c3;
...
void plotSpectraFractions_3CentBins(){

  file_pp = TFile::Open("../../rootFiles/spectraFractions/correctionFactors_pp.root");
  file_C3 = TFile::Open("../../rootFiles/spectraFractions/correctionFactors_C3.root");
  file_C2 = TFile::Open("../../rootFiles/spectraFractions/correctionFactors_C2.root");
  file_C1 = TFile::Open("../../rootFiles/spectraFractions/correctionFactors_C1.root");
  ...
  file_pp->GetObject("corrFactor_4_pp",corrFactor_4_pp);
  ...
  file_C3->GetObject("corrFactor_4_C3",corrFactor_4_C3);
  ...
  file_C2->GetObject("corrFactor_4_C2",corrFactor_4_C2);
  ...
  file_C1->GetObject("corrFactor_4_C1",corrFactor_4_C1);
  ...
  d0 = (TH1D*) corrFactor_4_pp->Clone("d0");
  d1 = (TH1D*) corrFactor_4_C1->Clone("d1");
  d2 = (TH1D*) corrFactor_4_C2->Clone("d2");
  d3 = (TH1D*) corrFactor_4_C3->Clone("d3");
  ...
  pad_a->Draw();
  pad_a->cd();
  a1->SetTitle("Fraction of gen-jets that are #font[52]{b}-jets");
  a1->GetXaxis()->SetTitle("#font[52]{p}_{T}^{genJet} [GeV]");
  a1->GetYaxis()->SetTitle("");
  a1->GetXaxis()->SetLabelSize(labelSize);
  a1->GetXaxis()->SetTitleSize(titleSize);
  a1->GetYaxis()->SetLabelSize(labelSize);
  a1->GetYaxis()->SetTitleSize(titleSize);
  a1->GetXaxis()->SetRangeUser(80,200);
  a1->GetYaxis()->SetRangeUser(0,0.15);
  //a0->Draw();
  //a1->Draw("same");
  a1->Draw();
  a2->Draw("same");
  ...
  pad_b->Draw();
  pad_b->cd();
  //b1->SetTitle("Fraction of gen #font[52]{b}-jets tagged with genMuon");
  b1->SetTitle("Fraction of reco #font[52]{b}-jets tagged with genMuon");
  b1->GetXaxis()->SetTitle("#font[52]{p}_{T}^{genJet} [GeV]");
  b1->GetYaxis()->SetTitle("");
  b1->GetXaxis()->SetLabelSize(labelSize);
  b1->GetXaxis()->SetTitleSize(titleSize);
  b1->GetYaxis()->SetLabelSize(labelSize);
  b1->GetYaxis()->SetTitleSize(titleSize);
  b1->GetYaxis()->SetRangeUser(0,0.15);
  b1->GetXaxis()->SetRangeUser(80,200);
  //b0->Draw();
  //b1->Draw("same");
  b1->Draw();
  b2->Draw("same");
  ...
  pad_c->Draw();
  pad_c->cd();
  c1->SetTitle("Fraction of gen #font[52]{b}-jets tagged with recoMuon");
  c1->GetXaxis()->SetTitle("#font[52]{p}_{T}^{genJet} [GeV]");
  c1->GetYaxis()->SetTitle("");
  c1->GetXaxis()->SetLabelSize(labelSize);
  c1->GetXaxis()->SetTitleSize(titleSize);
  c1->GetYaxis()->SetLabelSize(labelSize);
  c1->GetYaxis()->SetTitleSize(titleSize);
  c1->GetYaxis()->SetRangeUser(0.,.15);
  c1->GetXaxis()->SetRangeUser(80,200);
  ...
  pad_d->Draw();
  pad_d->cd();
  d0->SetTitle("Fraction of reco #font[52]{b}-jets tagged with recoMuon");
  ...
  d0->GetYaxis()->SetRangeUser(0,0.15);
