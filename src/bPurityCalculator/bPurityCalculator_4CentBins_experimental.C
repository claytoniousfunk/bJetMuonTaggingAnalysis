...
#include "../templateFitter/templateFitter_projectableTemplates_4CentBins_experimental.h"

void bPurityCalculator_4CentBins_experimental(){
  ...
  int do_bJetEnergyShift = 0; // centrality shift... prob should rename
