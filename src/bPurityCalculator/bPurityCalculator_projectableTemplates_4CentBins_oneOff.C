...
void bPurityCalculator_projectableTemplates_4CentBins_oneOff(){

  cout << endl;
  cout << "#######  RUNNING B-PURITY CALCULATOR (v. 4-cent-bins.One-Off) #########" << endl;
  cout << endl;
  ...
  templateFitter(do_data, do_pp,do_C1,do_C2,do_C3,do_C4,  low_jetPt,high_jetPt,  do_mergeC,do_mergeB,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_multiplier, bGS_multiplier, 1);
