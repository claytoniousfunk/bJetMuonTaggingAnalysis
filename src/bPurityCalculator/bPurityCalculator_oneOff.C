...
void bPurityCalculator_oneOff(){
  ...
  templateFitter(do_data, do_mu5,do_mu7,do_mu12,  do_pp,do_C1,do_C2,  do_J1,do_J2,do_J3,do_J4,do_J5,do_J6,  do_mergeC,do_mergeB,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_multiplier, 1);
