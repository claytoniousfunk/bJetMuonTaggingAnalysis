...
void ZeroColumnsUpTo(TH2D* h, double x_cutoff) {
    int x_bin_cutoff = h->GetXaxis()->FindBin(x_cutoff);
    for (int ix = 1; ix < x_bin_cutoff; ix++) {
...
void unfoldTest(){
  ...
  TFile *file_PbPb_SingleMuon = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PbPb/latest/PbPb_SingleMuon_mu12_pTmu-15to999_tight_WDecayFilter_2026-4-7.root");
  ...
  double responsePtCutoff = 0.;
  ZeroColumnsUpTo(h_response_pp_even,responsePtCutoff);
  ZeroColumnsUpTo(h_response_C4_even,responsePtCutoff);
  ZeroColumnsUpTo(h_response_C3_even,responsePtCutoff);
  ZeroColumnsUpTo(h_response_C2_even,responsePtCutoff);
  ZeroColumnsUpTo(h_response_C1_even,responsePtCutoff);
  ...
  // RooUnfoldInvert unfold_ppMC(&response_pp, h_ppMC);
  // RooUnfoldInvert unfold_C4MC(&response_C4, h_C4MC);
  // RooUnfoldInvert unfold_C3MC(&response_C3, h_C3MC);
  // RooUnfoldInvert unfold_C2MC(&response_C2, h_C2MC);
  // RooUnfoldInvert unfold_C1MC(&response_C1, h_C1MC);
  ...
  double chi2_C4_unfold_iterTest[N_iter_tot] = {};
  ...
  for(int i = 0; i < N_iter_tot; i++){
    ...
    if(i == 0){
      ...
      r_ppMC_iterTest_unfold[i]->GetYaxis()->SetRangeUser(0.,2.);
    }
  ...
  li->DrawLine(30,1,500,1);
  li->DrawLine(30,1.2,500,1.2);
  li->DrawLine(30,0.8,500,0.8);
  li->DrawLine(80,0,80,2);
  canv_ppMC_iterTest->SaveAs("../../figures/unfoldTest/ppMC_iterTest.pdf");


  /////////////////////////////////////////////////////////////////////////////////////////////

  TCanvas *canv_chi2_pp = new TCanvas("canv_chi2_pp","canv_chi2_pp",700,700);
  canv_chi2_pp->cd();
  TPad *pad_chi2_pp = new TPad("pad_chi2_pp","pad_chi2_pp",0,0,1,1);
  pad_chi2_pp->SetLeftMargin(0.15);
  pad_chi2_pp->SetBottomMargin(0.15);
  pad_chi2_pp->Draw();
  pad_chi2_pp->cd();
  TGraph *gr_chi2_pp = new TGraph(N_iter_tot,chi2_x,chi2_pp_unfold_iterTest);
  gr_chi2_pp->SetTitle("");
  gr_chi2_pp->GetYaxis()->SetTitle("#it{#chi}^{2}");
  gr_chi2_pp->GetXaxis()->SetTitle("#it{N}_{iterations}");
  ...
  TCanvas *canv_chi2_C4 = new TCanvas("canv_chi2_C4","canv_chi2_C4",700,700);
  canv_chi2_C4->cd();
  TPad *pad_chi2_C4 = new TPad("pad_chi2_C4","pad_chi2_C4",0,0,1,1);
  pad_chi2_C4->SetLeftMargin(0.15);
  pad_chi2_C4->SetBottomMargin(0.15);
  pad_chi2_C4->Draw();
  pad_chi2_C4->cd();
  TGraph *gr_chi2_C4 = new TGraph(N_iter_tot,chi2_x,chi2_C4_unfold_iterTest);
  gr_chi2_C4->SetTitle("");
  gr_chi2_C4->GetYaxis()->SetTitle("#it{#chi}^{2}");
  gr_chi2_C4->GetXaxis()->SetTitle("#it{N}_{iterations}");
  ...
  TCanvas *canv_chi2_C3 = new TCanvas("canv_chi2_C3","canv_chi2_C3",700,700);
  canv_chi2_C3->cd();
  TPad *pad_chi2_C3 = new TPad("pad_chi2_C3","pad_chi2_C3",0,0,1,1);
  pad_chi2_C3->SetLeftMargin(0.15);
  pad_chi2_C3->SetBottomMargin(0.15);
  pad_chi2_C3->Draw();
  pad_chi2_C3->cd();
  TGraph *gr_chi2_C3 = new TGraph(N_iter_tot,chi2_x,chi2_C3_unfold_iterTest);
  gr_chi2_C3->SetTitle("");
  gr_chi2_C3->GetYaxis()->SetTitle("#it{#chi}^{2}");
  gr_chi2_C3->GetXaxis()->SetTitle("#it{N}_{iterations}");
  gr_chi2_C3->SetMarkerStyle(20);
  gr_chi2_C3->Draw("AP");
  ...
  TCanvas *canv_chi2_C2 = new TCanvas("canv_chi2_C2","canv_chi2_C2",700,700);
  canv_chi2_C2->cd();
  TPad *pad_chi2_C2 = new TPad("pad_chi2_C2","pad_chi2_C2",0,0,1,1);
  pad_chi2_C2->SetLeftMargin(0.15);
  pad_chi2_C2->SetBottomMargin(0.15);
  pad_chi2_C2->Draw();
  pad_chi2_C2->cd();
  TGraph *gr_chi2_C2 = new TGraph(N_iter_tot,chi2_x,chi2_C2_unfold_iterTest);
  gr_chi2_C2->SetTitle("");
  gr_chi2_C2->GetYaxis()->SetTitle("#it{#chi}^{2}");
  gr_chi2_C2->GetXaxis()->SetTitle("#it{N}_{iterations}");
  gr_chi2_C2->SetMarkerStyle(20);
  gr_chi2_C2->Draw("AP");
  ...
  TCanvas *canv_chi2_C1 = new TCanvas("canv_chi2_C1","canv_chi2_C1",700,700);
  canv_chi2_C1->cd();
  TPad *pad_chi2_C1 = new TPad("pad_chi2_C1","pad_chi2_C1",0,0,1,1);
  pad_chi2_C1->SetLeftMargin(0.15);
  pad_chi2_C1->SetBottomMargin(0.15);
  pad_chi2_C1->Draw();
  pad_chi2_C1->cd();
  TGraph *gr_chi2_C1 = new TGraph(N_iter_tot,chi2_x,chi2_C1_unfold_iterTest);
  gr_chi2_C1->SetTitle("");
  gr_chi2_C1->GetYaxis()->SetTitle("#it{#chi}^{2}");
  gr_chi2_C1->GetXaxis()->SetTitle("#it{N}_{iterations}");
