void PYTHIA_skim_simple(int group = 1){
  ...
  output_file_base += Form("/eos/cms/store/group/phys_heavyions/cbennett/skims/output_skim_PYTHIA_DiJet_withGS_withJetTriggers/PYTHIA_DiJet_skim_output_%i",group);
  ...
  // int endfile = 20; // PYTHIA_DiJet_withJetTrackMaxInfo forest
