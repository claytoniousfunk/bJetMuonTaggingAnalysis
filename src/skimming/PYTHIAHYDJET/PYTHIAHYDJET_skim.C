...
void PYTHIAHYDJET_skim(int group = 0,
		       int startgroup = 0,
		       int endgroup = 20){
  ...
  while(instr>>filename && ifile<endfile){
    ...
    jet_tree->SetBranchAddress("matchedPartonFlavor",t_matchedPartonFlavor);
    jet_tree->SetBranchAddress("matchedHadronFlavor",t_matchedHadronFlavor);
    jet_tree->SetBranchAddress("refparton_flavorForB",t_refparton_flavorForB);
