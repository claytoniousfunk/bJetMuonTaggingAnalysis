...
void JES_compare(){
  ...
  TFile *f_nom = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/JES/JES_C1.root");
  TFile *f_JERSmear = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/JES/JES_JERSmear_C1.root");

  TH1D *h_nom, *h_JERSmear;

  // f_nom->GetObject("JER_result_b",h_nom);
  // f_JERSmear->GetObject("JER_result_b",h_JERSmear);
  f_nom->GetObject("JES_result_i",h_nom);
  f_JERSmear->GetObject("JES_result_i",h_JERSmear);
  ...
  r->GetYaxis()->SetTitle("#mu(smeared) / #mu(nom.)");
  ...
  canv->SaveAs("./figures/JES_compare.pdf");
