...
void jetEnergyResolutionCalculator_eta(bool ispp = 1,
  ...
  //else f1 = TFile::Open("~/Analysis/code/ecalTest/rootFiles_chris/PYTHIAHYDJET_ecalTests_barrelSafe.root"); // chirs ecalTest forest
  //else f1 = TFile::Open("~/Analysis/code/ecalTest/rootFiles_response/PYTHIAHYDJET_DiJet_response_ecalTest_barrelSafe.root"); // chirs ecalTest forest
  //else f1 = TFile::Open("~/Analysis/code/ecalTest/rootFiles_response/PYTHIAHYDJET_DiJet_response_ecalTest_barrelTarget.root"); // chirs ecalTest forest
  //else f1 = TFile::Open("~/Analysis/code/ecalTest/rootFiles_response/PYTHIAHYDJET_DiJet_response_ecalTest_barrelNominal.root"); // chirs ecalTest forest
  //else f1 = TFile::Open("~/Analysis/code/ecalTest/rootFiles_response/PYTHIAHYDJET_DiJet_response_ecalTest_endcapNominal.root"); // chirs ecalTest forest
  //else f1 = TFile::Open("~/Analysis/code/ecalTest/rootFiles_response/PYTHIAHYDJET_DiJet_response_ecalTest_endcapSafe.root"); // chirs ecalTest forest
  // else f1 = TFile::Open("~/Analysis/code/ecalTest/rootFiles_response/PYTHIAHYDJET_DiJet_response_ecalTest_endcapTarget.root"); // chirs ecalTest forest
  //else f1 = TFile::Open("~/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/PYTHIAHYDJET_DiJet_response.root"); // neutrinos included in genJets
  ...
  //else f1 = TFile::Open("/home/clayton/Analysis/code/skimming/PYTHIAHYDJET_scan/rootFiles/response/PYTHIAHYDJET_DiJet_MuJetsOnly_CsJets_response_JERsmear_12June23.root"); // neutrinos included in genJets
  //else f1 = TFile::Open("~/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/PYTHIAHYDJET/");
  ...
  if(ispp){
    ...
    f1->GetObject("h_matchedRecoJetPtOverGenJetPt_genJetEta_gJets",h4);
    f1->GetObject("h_matchedRecoJetPtOverGenJetPt_genJetEta_cJets",h5);
    f1->GetObject("h_matchedRecoJetPtOverGenJetPt_genJetEta_bJets",h6);
    f1->GetObject("h_matchedRecoJetPtOverGenJetPt_genJetEta_bJets",h7);
    ...
    f1->GetObject("h_matchedRecoJetPtOverGenJetPt_genJetEta_sJets_C2",h3);
    f1->GetObject("h_matchedRecoJetPtOverGenJetPt_genJetEta_gJets_C2",h4);
    f1->GetObject("h_matchedRecoJetPtOverGenJetPt_genJetEta_cJets_C2",h5);
  ...
  const int Nbins = 7;
  double pt_axis[Nbins] = {-1.6,-1.0,-0.6,0.0,0.6,1.0,1.6};

  // const int Nbins = 11;
  // double pt_axis[Nbins] = {-1.6,-1.0,-0.7,-0.4,-0.2,0.0,0.2,0.4,0.7,1.0,1.6};
  ...
  for(int i = 0; i < Nbins-1; i++){
    ...
    double aL_min = 0.0001;
    double aL_max = 0.1;
    double aL_init = 0.005;
    ...
    double fitLow = 0.3; // use this range for JES
    double fitHigh = 1.2;
    ...
    fxn7->SetParLimits(3,aL_min,aL_min);
  ...
  mg->GetYaxis()->SetRangeUser(0.78,1.32);
  mg->GetXaxis()->SetRangeUser(-1.6,1.6);
  mg->GetYaxis()->SetTitle("#mu (#font[52]{p}_{T}^{recoJet} / #font[52]{p}_{T}^{genJet})");
  mg->GetXaxis()->SetTitle("#it{#eta}^{genJet}");
  ...
  TLegend *l = new TLegend(0.64,0.6,0.89,0.88);
  l->SetBorderSize(0);
  l->SetTextFont(42);
  l->SetTextSize(0.036);
  l->SetFillStyle(0);
