...
void ptRandomCone(){
  ...
  TH1D *draw_data;
  draw_data = (TH1D*) ptRandomCone_hiBin_data->ProjectionX("draw_data",ptRandomCone_hiBin_data->ProjectionY()->FindBin(hiBin_proj_low_data),ptRandomCone_hiBin_data->ProjectionY()->FindBin(hiBin_proj_high_data));
  ...
  for(int i = 0; i < N_proj; i++){
    ...
    draw_mc[i] = (TH1D*) ptRandomCone_hiBin_mc->ProjectionX(Form("draw_mc_%i",i),ptRandomCone_hiBin_mc->ProjectionY()->FindBin(hiBin_proj_low_mc),ptRandomCone_hiBin_mc->ProjectionY()->FindBin(hiBin_proj_high_mc));
  ...
  draw_data->GetYaxis()->SetTitle("1/#it{N}^{cone}_{tot} d#it{N}^{cone}/d#it{p}_{T}^{cone}");
  ...
  r[0]->GetXaxis()->SetTitle("#it{p}_{T}^{cone} [GeV]");
  r[0]->Draw("hist");
