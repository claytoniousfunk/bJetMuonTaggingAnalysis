...
void PYTHIA_scan(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PYTHIA_DiJet_withGS_scan_mu7_tight_pTmu-9to14_pThat-15_removeHYDJETjets_leadingXjetDump/PYTHIA_DiJet_scan_output_%i.root",group);
