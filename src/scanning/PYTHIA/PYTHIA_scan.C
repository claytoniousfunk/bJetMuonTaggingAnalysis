...
void PYTHIA_scan(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PYTHIA_DiJet_withGS_mu12_tight_pTmu-14_pThat-30_removeHYDJETjet_jetTrkMaxFilter_vzReweight_jetPtReweight_newJetBins_JERsmear/PYTHIA_DiJet_scan_output_%i.root",group);
