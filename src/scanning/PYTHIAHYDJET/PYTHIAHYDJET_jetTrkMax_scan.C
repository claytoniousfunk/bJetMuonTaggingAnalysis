...
void PYTHIAHYDJET_jetTrkMax_scan(int group = 1){
  ...
  TString output = Form("/eos/user/c/cbennett/scanningOutput/output_PYTHIAHYDJET_DiJet_jetTrkMax_fineCentBins_pThat-20_trkpT-14_hiBinShift-0/PYTHIAHYDJET_scan_output_%i.root",group);   
