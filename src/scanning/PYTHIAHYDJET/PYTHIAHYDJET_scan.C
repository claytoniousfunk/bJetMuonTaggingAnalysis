...
void PYTHIAHYDJET_scan(int group = 1){
  ...
  for(int i = 0; i < NCentralityIndices; i++){
	...
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][0] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_allJets_C%iJ%i",i,j),Form("allJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][1] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_bJets_C%iJ%i",i,j),Form("bJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][2] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_cJets_C%iJ%i",i,j),Form("bJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][3] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_udJets_C%iJ%i",i,j),Form("udJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][4] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_sJets_C%iJ%i",i,j),Form("sJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][5] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_gJets_C%iJ%i",i,j),Form("gJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][6] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_xJets_C%iJ%i",i,j),Form("xJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][0] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_allJets_C%iJ%i",i,j),Form("allJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][1] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_bJets_C%iJ%i",i,j),Form("bJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][2] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_cJets_C%iJ%i",i,j),Form("cJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][3] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_udJets_C%iJ%i",i,j),Form("udJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][4] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_sJets_C%iJ%i",i,j),Form("sJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][5] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_gJets_C%iJ%i",i,j),Form("gJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][6] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_xJets_C%iJ%i",i,j),Form("xJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	...
	// new muptrel response matrices
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][0] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_allJets_C%iJ%i",i,j),Form("allJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][1] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_bJets_C%iJ%i",i,j),Form("bJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][2] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_cJets_C%iJ%i",i,j),Form("bJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][3] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_udJets_C%iJ%i",i,j),Form("udJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][4] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_sJets_C%iJ%i",i,j),Form("sJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][5] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_gJets_C%iJ%i",i,j),Form("gJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][6] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_xJets_C%iJ%i",i,j),Form("xJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);

	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][0] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_allJets_C%iJ%i",i,j),Form("allJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][1] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_bJets_C%iJ%i",i,j),Form("bJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][2] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_cJets_C%iJ%i",i,j),Form("cJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][3] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_udJets_C%iJ%i",i,j),Form("udJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][4] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_sJets_C%iJ%i",i,j),Form("sJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][5] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_gJets_C%iJ%i",i,j),Form("gJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][6] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_xJets_C%iJ%i",i,j),Form("xJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
      }
      else if(j==0){
	...
	// new muptrel response matrices
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][0] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_allJets_C%iJ%i",i,j),Form("allJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][1] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_bJets_C%iJ%i",i,j),Form("bJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][2] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_cJets_C%iJ%i",i,j),Form("bJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][3] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_udJets_C%iJ%i",i,j),Form("udJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][4] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_sJets_C%iJ%i",i,j),Form("sJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][5] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_gJets_C%iJ%i",i,j),Form("gJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][6] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_xJets_C%iJ%i",i,j),Form("xJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);

	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][0] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_allJets_C%iJ%i",i,j),Form("allJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][1] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_bJets_C%iJ%i",i,j),Form("bJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][2] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_cJets_C%iJ%i",i,j),Form("cJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][3] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_udJets_C%iJ%i",i,j),Form("udJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][4] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_sJets_C%iJ%i",i,j),Form("sJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][5] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_gJets_C%iJ%i",i,j),Form("gJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][6] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_xJets_C%iJ%i",i,j),Form("xJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[0],jetPtEdges[NJetPtIndices-1],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
      }
      else{
	...
	// new muptrel response matrices
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][0] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_allJets_C%iJ%i",i,j),Form("allJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][1] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_bJets_C%iJ%i",i,j),Form("bJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][2] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_cJets_C%iJ%i",i,j),Form("bJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][3] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_udJets_C%iJ%i",i,j),Form("udJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][4] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_sJets_C%iJ%i",i,j),Form("sJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][5] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_gJets_C%iJ%i",i,j),Form("gJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon[i][j][6] = new TH2D(Form("h_muptrelGenJetGenMuon_muptrelRecoJetRecoMuon_xJets_C%iJ%i",i,j),Form("xJets, muon pTrel (genJet,genMuon) vs. muon pTrel(recoJet,matchedRecoMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),NMuRelPtBins,muRelPtMin,muRelPtMax,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][0] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_allJets_C%iJ%i",i,j),Form("allJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][1] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_bJets_C%iJ%i",i,j),Form("bJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][2] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_cJets_C%iJ%i",i,j),Form("cJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][3] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_udJets_C%iJ%i",i,j),Form("udJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][4] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_sJets_C%iJ%i",i,j),Form("sJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][5] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_gJets_C%iJ%i",i,j),Form("gJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
	h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon[i][j][6] = new TH2D(Form("h_muptrelRecoJetRecoMuonOverMuptrelGenJetGenMuon_muptrelGenJetGenMuon_xJets_C%iJ%i",i,j),Form("xJets, muon pTrel(recoJet,matchedRecoMuon) / muon pTrel (genJet,genMuon) vs. muon pTrel (genJet,genMuon), p_{T}^{jet} %3.0f - %3.0f, hiBin %3.0f - %3.0f",jetPtEdges[j-1],jetPtEdges[j],centEdges[i-1],centEdges[i]),100,0,5,NMuRelPtBins,muRelPtMin,muRelPtMax);
      }
