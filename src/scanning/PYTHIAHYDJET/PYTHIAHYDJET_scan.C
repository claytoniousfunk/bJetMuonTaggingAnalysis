...
void PYTHIAHYDJET_scan(int group = 1){
  ...
  //TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PYTHIAHYDJET_DiJet_withGS_scan_mu12_tight_pThat15_removeHYDJETjets_jetPtReweight_vzReweight_hiBinReweight/PYTHIAHYDJET_scan_output_%i.root",group);
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PYTHIAHYDJET_BJet_withGS_scan_mu7_tight_pTwindow_pThat15_removeHYDJETjets_jetPtReweight_vzReweight_hiBinReweight/PYTHIAHYDJET_scan_output_%i.root",group);
