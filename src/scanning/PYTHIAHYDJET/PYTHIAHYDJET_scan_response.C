...
void PYTHIAHYDJET_scan_response(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PH_DiJet_pTjet-5_pThat-15_removeHYDJETjet0p45_response_fineCentBins_correctHiBinShift/PYTHIAHYDJET_scan_output_%i.root",group);
