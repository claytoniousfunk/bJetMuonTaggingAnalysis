...
void PYTHIAHYDJET_scan_response(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PH_DiJet_pTjet-5_pThat-25_response_fineCentBins/PYTHIAHYDJET_scan_output_%i.root",group);
