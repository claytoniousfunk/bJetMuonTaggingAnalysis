...
void pp_scan(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_pp_SingleMuon_mu7_tight_pTmu-9to14/pp_SingleMuon_scan_output_%i.root",group);
