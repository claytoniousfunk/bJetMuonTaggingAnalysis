...
void HYDJET_pfCandAnalyzer(int group = 1){
  ...
  std::string inputFileList = "../../../fileNames/fileNames_MinBias_Hydjet_Drum5F_2018_5p02TeV_withTracks.txt";
  ...
  while(instr>>filename){
	...
	if(triggerIsOn(triggerDecision_mu12,triggerDecision_mu12_Prescl)){
      ...
      int N_generatedPseudoJets = 10000; // define how many psuedo jets to create
