...
void HYDJET_trigger_scan(int group = 1){


  
  TString input = Form("../../../rootFiles/skimmingOutput/PYTHIAHYDJET/output_MinBias/HYDJET_MinBias_skim_output_%i.root",group);
  TString output = Form("output_HYDJET_scan_mu7/HYDJET_scan_output_%i.root",group);
