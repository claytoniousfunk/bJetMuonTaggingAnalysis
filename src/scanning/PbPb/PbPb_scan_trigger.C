...
///////////////////////  start the program
void PbPb_scan_trigger(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PbPb_SingleMuon_triggerScan/PbPb_SingleMuon_scan_output_%i.root",group);
