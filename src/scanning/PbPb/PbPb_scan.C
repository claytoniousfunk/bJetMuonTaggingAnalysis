...
void PbPb_scan(int group = 1){
  ...
  for(int evi = 0; evi < NEvents; evi++){
    ...
    if(doSingleMuonSample) loopTrigger = triggerDecision_mu12;
      ...
      if(applyJet60Trigger) loopTrigger = em->HLT_HICsAK4PFJet60Eta1p5_v1;
      else if(applyJet80Trigger) loopTrigger = em->HLT_HICsAK4PFJet80Eta1p5_v1;
      else if(applyJet100Trigger) loopTrigger = em->HLT_HICsAK4PFJet100Eta1p5_v1;
      else loopTrigger = 1;
    }
    else loopTrigger = 1;
