...
void PbPb_scan(int group = 1){
  ...
  // TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PbPb_HardProbes_scan_jet80_mu12_tight_pTmu-14_hiHFcut_fineCentBins_projectableTemplates/PbPb_HardProbes_scan_output_%i.root",group);
