...
void PbPb_scan(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PbPb_HardProbes_scan_mu12_tight_pTmu-14_hiHFcut_2025-10-13_applyJEUShiftUp/PbPb_HardProbes_scan_output_%i.root",group);
