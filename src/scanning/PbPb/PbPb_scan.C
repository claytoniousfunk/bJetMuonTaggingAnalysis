...
void PbPb_scan(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PbPb_SingleMuon_scan_mu7_tight_updatedTriggerLogic/PbPb_SingleMuon_scan_output_%i.root",group);
