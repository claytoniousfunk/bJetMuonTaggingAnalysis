...
void PbPb_jetTrkMax_scan(int group = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_PbPb_DiJet_onlyJets_withTrackMaxInfo_partial_jetTrkMax_ultraFineCentBins_jet60/PbPb_scan_output_%i.root",group);
