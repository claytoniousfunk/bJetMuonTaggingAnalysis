...
#include "plotJetTrkMaxDR_PYTHIAVsPYTHIAHYDJET.h"
...
void plotJetTrkMaxDR_PYTHIAVsPYTHIAHYDJET(int j = 1){
  ...
  if(!file_pp_mc_raw || !file_PbPb_mc_raw){
  ...
  r_C5 = (TH1D*) h_dR_C5_mc_raw->Clone("r_C5");
  r_C4 = (TH1D*) h_dR_C4_mc_raw->Clone("r_C4");
  r_C3 = (TH1D*) h_dR_C3_mc_raw->Clone("r_C3");
  r_C2 = (TH1D*) h_dR_C2_mc_raw->Clone("r_C2");
  r_C1 = (TH1D*) h_dR_C1_mc_raw->Clone("r_C1");


  r_C5->Divide(h_dR_C5_mc_raw,h_dR_pp_mc_raw,1,1,"");
  r_C4->Divide(h_dR_C4_mc_raw,h_dR_pp_mc_raw,1,1,"");
  r_C3->Divide(h_dR_C3_mc_raw,h_dR_pp_mc_raw,1,1,"");
  r_C2->Divide(h_dR_C2_mc_raw,h_dR_pp_mc_raw,1,1,"");
  r_C1->Divide(h_dR_C1_mc_raw,h_dR_pp_mc_raw,1,1,"");  
  ...
  leg_C5->AddEntry(h_dR_pp_mc_raw,"PYTHIA","p");
  leg_C5->AddEntry(h_dR_C5_mc_raw,"P+H 70-80%","p");

  leg_C4 = new TLegend(0.5,0.3,0.84,0.6);
  leg_C4->SetFillStyle(0);
  leg_C4->SetBorderSize(0);
  leg_C4->SetTextSize(0.04);
  leg_C4->AddEntry(h_dR_pp_mc_raw,"PYTHIA","p");
  leg_C4->AddEntry(h_dR_C4_mc_raw,"P+H 50-70%","p");

  leg_C3 = new TLegend(0.5,0.3,0.84,0.6);
  leg_C3->SetFillStyle(0);
  leg_C3->SetBorderSize(0);
  leg_C3->SetTextSize(0.04);
  leg_C3->AddEntry(h_dR_pp_mc_raw,"PYTHIA","p");
  leg_C3->AddEntry(h_dR_C3_mc_raw,"P+H 30-50%","p");

  leg_C2 = new TLegend(0.5,0.3,0.84,0.6);
  leg_C2->SetFillStyle(0);
  leg_C2->SetBorderSize(0);
  leg_C2->SetTextSize(0.04);
  leg_C2->AddEntry(h_dR_pp_mc_raw,"PYTHIA","p");
  leg_C2->AddEntry(h_dR_C2_mc_raw,"P+H 10-30%","p");

  leg_C1 = new TLegend(0.5,0.3,0.84,0.6);
  leg_C1->SetFillStyle(0);
  leg_C1->SetBorderSize(0);
  leg_C1->SetTextSize(0.04);
  leg_C1->AddEntry(h_dR_pp_mc_raw,"PYTHIA","p");
  leg_C1->AddEntry(h_dR_C1_mc_raw,"P+H 0-10%","p");
  ...
  canv_C5->SaveAs(Form("./figures/jetTrkMaxDR_PYTHIAVsPYTHIAHYDJET/C5_%i.pdf",j));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  canv_C4->SaveAs(Form("./figures/jetTrkMaxDR_PYTHIAVsPYTHIAHYDJET/C4_%i.pdf",j));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  canv_C3->SaveAs(Form("./figures/jetTrkMaxDR_PYTHIAVsPYTHIAHYDJET/C3_%i.pdf",j));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  canv_C2->SaveAs(Form("./figures/jetTrkMaxDR_PYTHIAVsPYTHIAHYDJET/C2_%i.pdf",j));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  canv_C1->SaveAs(Form("./figures/jetTrkMaxDR_PYTHIAVsPYTHIAHYDJET/C1_%i.pdf",j));
