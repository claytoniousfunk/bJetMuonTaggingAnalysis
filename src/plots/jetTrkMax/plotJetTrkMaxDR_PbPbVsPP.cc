...
#include "plotJetTrkMaxDR_PbPbVsPP.h"
...
void plotJetTrkMaxDR_PbPbVsPP(int j = 1){
  ...
  h_dR_C5_data->GetYaxis()->SetTitle("1/#it{N} d#it{N}/d#DeltaR");
  ...
  h_dR_C4_data->GetYaxis()->SetTitle("1/#it{N} d#it{N}/d#DeltaR");
  ...
  h_dR_C3_data->GetYaxis()->SetTitle("1/#it{N} d#it{N}/d#DeltaR");
  ...
  h_dR_C2_data->GetYaxis()->SetTitle("1/#it{N} d#it{N}/d#DeltaR");
  ...
  h_dR_C1_data->GetYaxis()->SetTitle("1/#it{N} d#it{N}/d#DeltaR");
