...
void plotJetTrkMaxPtRel_JERSmearEffect(bool isPP = 1,
				       bool isC4 = 0,
				       bool isC3 = 0,
				       bool isC2 = 0,
				       bool isC1 = 0,
   ...
   if(isPP){
     ...
     f1 = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/latest/jetTrkMax/PYTHIA_DiJet_jetTrkMax_pThat-30_mu12_pTmu-14_tight_vzReweight_jetPtReweight_jetTrkMaxFilter_removeHYDJETjet0p45_2025-11-11.root");
     ...
     f1 = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/jetTrkMax/PYTHIAHYDJET_DiJet_jetTrkMax_pThat-30_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_2025-11-11.root");
   ...
   if(isPP){
     ...
     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_T1",H1);  
     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_T0",H2);

     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice14to17_T1",H1);  
     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice14to17_T0",H2);

     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice17to20_T1",H1);  
     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice17to20_T0",H2);

     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice20to25_T1",H1);  
     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice20to25_T0",H2);

     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice25to30_T1",H1);  
     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice25to30_T0",H2);

     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice30to40_T1",H1);  
     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice30to40_T0",H2);

     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice40toInf_T1",H1);  
     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_PtSlice40toInf_T0",H2);
	 
   }

   else if(isC4){

     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C5T1",H1);
     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C4T1",H1);
     
     // f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C5T0",H2);
     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C4T0",H2);
     ...
     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C3T1",H1);
     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C3T0",H2);        
   
   }

   else if(isC2){

     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C2T1",H1);
     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C2T0",H2);

   }

   else if(isC1){

     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C1T1",H1);
     f1->GetObject("h_jetTrkMaxPtRel_recoJetPt_C1T0",H2);
   ...
   h1r->GetYaxis()->SetTitle("1/#font[52]{N}^{#it{h}}_{tot} d#font[52]{N}^{#it{h}}/d#font[52]{p}_{T}^{rel} [GeV^{-1}]");
   ...
   r1->GetXaxis()->SetTitle("Leading-hadron #font[52]{p}_{T}^{rel} [GeV]");
   ...
   h1r->GetYaxis()->SetRangeUser(0,1.08);
   ...
   la->DrawLatexNDC(la_x_pos,la_y_pos-0.2,"#it{p}_{T}^{#it{h}} > 14 GeV, |#it{#eta}^{#it{h}}| < 2.0");
   //la->DrawLatexNDC(la_x_pos,la_y_pos-0.2,"14 < #it{p}_{T}^{#it{h}} (GeV) < 17, |#it{#eta}^{#it{h}}| < 2.0");
   //la->DrawLatexNDC(la_x_pos,la_y_pos-0.2,"17 < #it{p}_{T}^{#it{h}} (GeV) < 20, |#it{#eta}^{#it{h}}| < 2.0");
   //la->DrawLatexNDC(la_x_pos,la_y_pos-0.2,"20 < #it{p}_{T}^{#it{h}} (GeV) < 25, |#it{#eta}^{#it{h}}| < 2.0");
   //la->DrawLatexNDC(la_x_pos,la_y_pos-0.2,"25 < #it{p}_{T}^{#it{h}} (GeV) < 30, |#it{#eta}^{#it{h}}| < 2.0");
   //la->DrawLatexNDC(la_x_pos,la_y_pos-0.2,"30 < #it{p}_{T}^{#it{h}} (GeV) < 40, |#it{#eta}^{#it{h}}| < 2.0");
   //la->DrawLatexNDC(la_x_pos,la_y_pos-0.2,"#it{p}_{T}^{#it{h}} > 40 GeV, |#it{#eta}^{#it{h}}| < 2.0");
