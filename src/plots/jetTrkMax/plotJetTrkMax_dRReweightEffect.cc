...
#include "plotJetTrkMax_dRReweightEffect.h"
...
void plotJetTrkMax_dRReweightEffect(double jetPt_low = 80.,
  ...
  file_PbPb_mc_raw = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/jetTrkMax/PYTHIAHYDJET_DiJet_jetTrkMax_pThat-20_trkpT-14_hiBinShift-10_ultraFineCentBins_2025-07-21.root");
  ...
  file_pp_mc_weighted->GetObject("h_jetTrkMaxPtRel_recoJetPt_T0",H_pTrel_pp_mc_weighted);

  file_PbPb_mc_raw->GetObject("h_jetTrkMaxPtRel_recoJetPt_C5T0",H_pTrel_C5_mc_raw);
  file_PbPb_mc_weighted->GetObject("h_jetTrkMaxPtRel_recoJetPt_C5T0",H_pTrel_C5_mc_weighted);

  file_PbPb_mc_raw->GetObject("h_jetTrkMaxPtRel_recoJetPt_C4T0",H_pTrel_C4_mc_raw);
  file_PbPb_mc_weighted->GetObject("h_jetTrkMaxPtRel_recoJetPt_C4T0",H_pTrel_C4_mc_weighted);

  file_PbPb_mc_raw->GetObject("h_jetTrkMaxPtRel_recoJetPt_C3T0",H_pTrel_C3_mc_raw);
  file_PbPb_mc_weighted->GetObject("h_jetTrkMaxPtRel_recoJetPt_C3T0",H_pTrel_C3_mc_weighted);

  file_PbPb_mc_raw->GetObject("h_jetTrkMaxPtRel_recoJetPt_C2T0",H_pTrel_C2_mc_raw);
  file_PbPb_mc_weighted->GetObject("h_jetTrkMaxPtRel_recoJetPt_C2T0",H_pTrel_C2_mc_weighted);

  file_PbPb_mc_raw->GetObject("h_jetTrkMaxPtRel_recoJetPt_C1T0",H_pTrel_C1_mc_raw);
  file_PbPb_mc_weighted->GetObject("h_jetTrkMaxPtRel_recoJetPt_C1T0",H_pTrel_C1_mc_weighted);
  ...
  h_pTrel_C5_mc_weighted = (TH1D*) H_pTrel_C5_mc_weighted->ProjectionX("h_pTrel_C5_mc_weighted",binFinder->FindBin(jetPt_low + smallShift),binFinder->FindBin(jetPt_high - smallShift));
  ...
  r_C5 = (TH1D*) h_pTrel_C5_mc_weighted->Clone("r_C5");
  ...
  r_C5->Divide(h_pTrel_C5_mc_weighted,h_pTrel_C5_mc_raw,1,1,"B");
  ...
  leg_C4->AddEntry(h_pTrel_C4_mc_weighted,"P+H 50-70% w/ #DeltaR reweight","p");
  ...
  //canv_pp->SaveAs(Form("./figures/dRReweightEffect/pp_J%i.pdf",j));
  ...
  r_C5->GetYaxis()->SetRangeUser(0.7,1.3);
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  //canv_C4->SaveAs(Form("./figures/dRReweightEffect/C4_J%i.pdf",j));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  //canv_C3->SaveAs(Form("./figures/dRReweightEffect/C3_J%i.pdf",j));   
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  //canv_C2->SaveAs(Form("./figures/dRReweightEffect/C2_J%i.pdf",j));   
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  //canv_C1->SaveAs(Form("./figures/dRReweightEffect/C1_J%i.pdf",j));   
  ...
  // r_R->GetYaxis()->SetRangeUser(0.7,1.3);
