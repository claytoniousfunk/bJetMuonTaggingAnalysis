...
#include "plotJetTrkMaxDR_proj.h"
...
void plotJetTrkMaxDR_proj(int j = 1,
			  double jetPt_low = 80,
  ...
  //file_pp_mc_raw = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/latest/jetTrkMax/PYTHIA_DiJet_jetTrkMax_pThat-20_mu12_pTmu-14_tight_vzReweight_jetPtReweight_jetTrkMaxFilter_removeHYDJETjet0p45_2025-8-21.root");
  file_pp_mc_raw = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/latest/jetTrkMax/PYTHIA_DiJet_jetTrkMax_pThat-15_mu12_pTmu-14_tight_vzReweight_jetTrkMaxFilter_removeHYDJETjet0p35CutOnGen_2026-1-26_RaiseJetPtBy20Percent.root");
  ...
  file_pp_mc_raw->GetObject("h_jetTrkMaxDR_recoJetPt_T0",H_dR_pp_mc_raw);
  file_pp_mc_weighted->GetObject(Form("h_jetTrkMaxDR_J%i",j),h_dR_pp_mc_weighted);

  TH1D *binFinder = H_dR_pp_mc_raw->ProjectionY();
  TAxis *yaxis = binFinder->GetXaxis();
  double smallShift = 0.01;

  h_dR_pp_mc_raw = (TH1D*) H_dR_pp_mc_raw->ProjectionX("h_dR_pp_mc_raw",binFinder->FindBin(jetPt_low+smallShift),binFinder->FindBin(jetPt_high-smallShift));

  file_PbPb_mc_raw->GetObject(Form("h_jetTrkMaxDR_C5J%i",j),h_dR_C5_mc_raw);
  file_PbPb_mc_weighted->GetObject(Form("h_jetTrkMaxDR_C5J%i",j),h_dR_C5_mc_weighted);

  file_PbPb_mc_raw->GetObject(Form("h_jetTrkMaxDR_C4J%i",j),h_dR_C4_mc_raw);
  file_PbPb_mc_weighted->GetObject(Form("h_jetTrkMaxDR_C4J%i",j),h_dR_C4_mc_weighted);

  file_PbPb_mc_raw->GetObject(Form("h_jetTrkMaxDR_C3J%i",j),h_dR_C3_mc_raw);
  file_PbPb_mc_weighted->GetObject(Form("h_jetTrkMaxDR_C3J%i",j),h_dR_C3_mc_weighted);

  file_PbPb_mc_raw->GetObject(Form("h_jetTrkMaxDR_C2J%i",j),h_dR_C2_mc_raw);
  file_PbPb_mc_weighted->GetObject(Form("h_jetTrkMaxDR_C2J%i",j),h_dR_C2_mc_weighted);

  file_PbPb_mc_raw->GetObject(Form("h_jetTrkMaxDR_C1J%i",j),h_dR_C1_mc_raw);
  file_PbPb_mc_weighted->GetObject(Form("h_jetTrkMaxDR_C1J%i",j),h_dR_C1_mc_weighted);
  ...
  h_dR_C4_data->Add(h_dR_C5_data);
  h_dR_C4_mc_raw->Add(h_dR_C5_mc_raw);
  h_dR_C4_mc_weighted->Add(h_dR_C5_mc_weighted);
  ...
  set_dR_range(h_dR_pp_mc_weighted);
  set_dR_range(h_dR_C5_mc_weighted);
  set_dR_range(h_dR_C4_mc_weighted);
  set_dR_range(h_dR_C3_mc_weighted);
  set_dR_range(h_dR_C2_mc_weighted);
  set_dR_range(h_dR_C1_mc_weighted);
  ...
  h_dR_pp_mc_weighted = (TH1D*) h_dR_pp_mc_weighted->Rebin(Nedge_dR-1,"h_dR_pp_mc_weighted",dR_axis);
  h_dR_C5_mc_weighted = (TH1D*) h_dR_C5_mc_weighted->Rebin(Nedge_dR-1,"h_dR_C5_mc_weighted",dR_axis);
  h_dR_C4_mc_weighted = (TH1D*) h_dR_C4_mc_weighted->Rebin(Nedge_dR-1,"h_dR_C4_mc_weighted",dR_axis);
  h_dR_C3_mc_weighted = (TH1D*) h_dR_C3_mc_weighted->Rebin(Nedge_dR-1,"h_dR_C3_mc_weighted",dR_axis);
  h_dR_C2_mc_weighted = (TH1D*) h_dR_C2_mc_weighted->Rebin(Nedge_dR-1,"h_dR_C2_mc_weighted",dR_axis);
  h_dR_C1_mc_weighted = (TH1D*) h_dR_C1_mc_weighted->Rebin(Nedge_dR-1,"h_dR_C1_mc_weighted",dR_axis);
  ...
  divideByBinwidth(h_dR_pp_mc_weighted);
  divideByBinwidth(h_dR_C5_mc_weighted);
  divideByBinwidth(h_dR_C4_mc_weighted);
  divideByBinwidth(h_dR_C3_mc_weighted);
  divideByBinwidth(h_dR_C2_mc_weighted);
  divideByBinwidth(h_dR_C1_mc_weighted);
  ...
  stylize_weighted(h_dR_pp_mc_weighted,h_dR_C5_mc_weighted,h_dR_C4_mc_weighted,h_dR_C3_mc_weighted,h_dR_C2_mc_weighted,h_dR_C1_mc_weighted);
  stylize_data(h_dR_pp_data,h_dR_C5_data,h_dR_C4_data,h_dR_C3_data,h_dR_C2_data,h_dR_C1_data);

  

  r_pp = (TH1D*) h_dR_pp_data->Clone("r_pp");
  ...
  r_pp->Divide(h_dR_pp_data,h_dR_pp_mc_raw,1,1,"B");
  r_C5->Divide(h_dR_C5_data,h_dR_C5_mc_raw,1,1,"B");
  r_C4->Divide(h_dR_C4_data,h_dR_C4_mc_raw,1,1,"B");
  r_C3->Divide(h_dR_C3_data,h_dR_C3_mc_raw,1,1,"B");
  r_C2->Divide(h_dR_C2_data,h_dR_C2_mc_raw,1,1,"B");
  r_C1->Divide(h_dR_C1_data,h_dR_C1_mc_raw,1,1,"B");
  ...
  //leg_pp->AddEntry(h_dR_pp_mc_weighted,"PYTHIA w/ #DeltaR reweight","p");
  ...
  //leg_C5->AddEntry(h_dR_C5_mc_weighted,"P+H 70-80% w/ #DeltaR reweight","p");
  ...
  leg_C4->AddEntry(h_dR_C4_mc_raw,"P+H 50-80% raw","p");
  leg_C4->AddEntry(h_dR_C4_data,"PbPb 50-80%","p");
  //leg_C4->AddEntry(h_dR_C4_mc_weighted,"P+H 50-80% w/ #DeltaR reweight","p");
  ...
  //leg_C3->AddEntry(h_dR_C3_mc_weighted,"P+H 30-50% w/ #DeltaR reweight","p");
  ...
  //leg_C2->AddEntry(h_dR_C2_mc_weighted,"P+H 10-30% w/ #DeltaR reweight","p");
  ...
  //leg_C1->AddEntry(h_dR_C1_mc_weighted,"P+H 0-10% w/ #DeltaR reweight","p");
  ...
  r_pp->GetXaxis()->SetTitle("#DeltaR(leading-hadron,jet)");
  ...
  canv_pp->SaveAs(Form("./figures/jetTrkMaxDR/pp_J%i.pdf",j));
  ...
  r_C5->GetXaxis()->SetTitle("#DeltaR(leading-hadron,jet)");
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  //canv_C5->SaveAs(Form("./figures/dRReweightEffect/C5_J%i.pdf",j));
  ...
  r_C4->GetXaxis()->SetTitle("#DeltaR(leading-hadron,jet)");
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  canv_C4->SaveAs(Form("./figures/jetTrkMaxDR/C4_J%i.pdf",j));
  ...
  r_C3->GetXaxis()->SetTitle("#DeltaR(leading-hadron,jet)");
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  canv_C3->SaveAs(Form("./figures/jetTrkMaxDR/C3_J%i.pdf",j));   
  ...
  r_C2->GetXaxis()->SetTitle("#DeltaR(leading-hadron,jet)");
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  canv_C2->SaveAs(Form("./figures/jetTrkMaxDR/C2_J%i.pdf",j));   
  ...
  r_C1->GetXaxis()->SetTitle("#DeltaR(leading-hadron,jet)");
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,0.3,1);
  canv_C1->SaveAs(Form("./figures/jetTrkMaxDR/C1_J%i.pdf",j));   
  ...
  // pad_R_2->Draw();
  // pad_R_1->cd();
  // h_dR_R_mc_raw->GetYaxis()->SetTitleSize(0.6*subTitleSize);
  // h_dR_R_mc_raw->GetYaxis()->SetLabelSize(0.6*subLabelSize);
  // h_dR_R_mc_raw->GetYaxis()->SetTitleOffset(0.9);
  // h_dR_R_mc_raw->GetYaxis()->SetTitle("1/#it{N} d#it{N}/d#it{p}_{T}^{rel} [GeV^{-1}]");
  // h_dR_R_mc_raw->GetYaxis()->SetRangeUser(0,0.35);
  // h_dR_R_mc_raw->Draw();
  // h_dR_R_mc_weighted->Draw("same");
  // leg_R->Draw();
  // la->DrawLatexNDC(0.12,0.92,CMSString);
  // la->DrawLatexNDC(0.74,0.92,energyString);
  // la->DrawLatexNDC(0.4,0.8,jetPtString);
  ...
  // r_R->GetXaxis()->SetTitle("#DeltaR(leading-hadron,jet)");
  // r_R->GetXaxis()->SetTitleSize(subTitleSize);
  // r_R->GetXaxis()->SetLabelSize(subLabelSize);
  // r_R->Draw();
  // li->SetLineStyle(7);
  // li->DrawLine(0,1,0.3,1);
  // canv_R->SaveAs(Form("./figures/dRReweightEffect/R_J%i.pdf",j));   
