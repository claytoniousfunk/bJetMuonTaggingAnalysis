...
#include "plotMuonPtRel_jetAxisSmearingEffect.h"
...
void plotMuonPtRel_jetAxisSmearingEffect(double jetPt_low = 80.,
  ...
  file_pp_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_T0",H_pTrel_pp_mc_raw);
