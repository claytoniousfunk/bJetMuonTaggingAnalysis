...
void plotJetTrkMaxPtRel_PYTHIAHYDJETVsPYTHIA(int j = 1){
  ...
  file_pp_data = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/latest/jetTrkMax/PYTHIA_DiJet_jetTrkMax_pThat-20_mu12_pTmu-14_tight_vzReweight_jetPtReweight_jetTrkMaxFilter_removeHYDJETjet0p45_2025-8-21.root");
  file_PbPb_data = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/jetTrkMax/PYTHIAHYDJET_DiJet_jetTrkMax_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_2025-8-1.root");
  ...
  leg_C5->AddEntry(h_dR_pp_data,"PYTHIA","p");
  leg_C5->AddEntry(h_dR_C5_data,"PYTHIA+HYDJET 70-80%","p");

  leg_C4 = new TLegend(0.5,0.3,0.84,0.6);
  leg_C4->SetFillStyle(0);
  leg_C4->SetBorderSize(0);
  leg_C4->SetTextSize(0.04);
  leg_C4->AddEntry(h_dR_pp_data,"PYTHIA","p");
  leg_C4->AddEntry(h_dR_C4_data,"PYTHIA+HYDJET 50-70%","p");
