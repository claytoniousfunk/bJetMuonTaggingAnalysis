...
void stylize_smeared(TH1D *h0, TH1D *h1, TH1D *h2, TH1D *h3, TH1D *h4){
...
void stylize_data(TH1D *h0, TH1D *h1, TH1D *h2, TH1D *h3, TH1D *h4){
...
void plotMuonPtRel(double jetPt_low = 80.,
  ...
  file_pp_mc_smeared = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/latest/PYTHIA_DiJet_pThat-20_mu12_pTmu-14_tight_vzReweight_jetPtReweight_jetTrkMaxFilter_removeHYDJETjet0p45_jetAxisSmear-0p01_2025-7-25.root");

  file_PbPb_MuJet_mc_raw = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/PYTHIAHYDJET_MuJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_2025-6-3.root");
  file_PbPb_MuJet_mc_smeared = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/PYTHIAHYDJET_MuJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_jetAxisSmear_2025-7-25.root");

  file_PbPb_BJet_mc_raw = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/PYTHIAHYDJET_BJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_2025-6-3.root");
  file_PbPb_BJet_mc_smeared = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/PYTHIAHYDJET_BJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_jetAxisSmear_2025-7-25.root");
  ...
  file_pp_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_T1",H_pTrel_pp_mc_raw);
  file_pp_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_T0",H_pTrel_pp_mc_smeared);
  

  file_PbPb_MuJet_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C4T0",H_pTrel_C4_MuJet_mc_raw);
  file_PbPb_MuJet_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C4T0",H_pTrel_C4_MuJet_mc_smeared);

  file_PbPb_BJet_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C4T0",H_pTrel_C4_BJet_mc_raw);
  file_PbPb_BJet_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C4T0",H_pTrel_C4_BJet_mc_smeared);

  H_pTrel_C4_MuJet_mc_raw->Add(H_pTrel_C4_BJet_mc_raw);
  H_pTrel_C4_MuJet_mc_smeared->Add(H_pTrel_C4_BJet_mc_smeared);

  file_PbPb_MuJet_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C3T0",H_pTrel_C3_MuJet_mc_raw);
  file_PbPb_MuJet_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C3T0",H_pTrel_C3_MuJet_mc_smeared);

  file_PbPb_BJet_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C3T0",H_pTrel_C3_BJet_mc_raw);
  file_PbPb_BJet_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C3T0",H_pTrel_C3_BJet_mc_smeared);

  H_pTrel_C3_MuJet_mc_raw->Add(H_pTrel_C3_BJet_mc_raw);
  H_pTrel_C3_MuJet_mc_smeared->Add(H_pTrel_C3_BJet_mc_smeared);

  file_PbPb_MuJet_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C2T0",H_pTrel_C2_MuJet_mc_raw);
  file_PbPb_MuJet_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C2T0",H_pTrel_C2_MuJet_mc_smeared);

  file_PbPb_BJet_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C2T0",H_pTrel_C2_BJet_mc_raw);
  file_PbPb_BJet_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C2T0",H_pTrel_C2_BJet_mc_smeared);

  H_pTrel_C2_MuJet_mc_raw->Add(H_pTrel_C2_BJet_mc_raw);
  H_pTrel_C2_MuJet_mc_smeared->Add(H_pTrel_C2_BJet_mc_smeared);

  file_PbPb_MuJet_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C1T0",H_pTrel_C1_MuJet_mc_raw);
  file_PbPb_MuJet_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C1T0",H_pTrel_C1_MuJet_mc_smeared);

  file_PbPb_BJet_mc_raw->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C1T0",H_pTrel_C1_BJet_mc_raw);
  file_PbPb_BJet_mc_smeared->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C1T0",H_pTrel_C1_BJet_mc_smeared);

  H_pTrel_C1_MuJet_mc_raw->Add(H_pTrel_C1_BJet_mc_raw);
  H_pTrel_C1_MuJet_mc_smeared->Add(H_pTrel_C1_BJet_mc_smeared);

  H_pTrel_C4_mc_raw = (TH2D*) H_pTrel_C4_MuJet_mc_raw->Clone("H_pTrel_C4_mc_raw");
  H_pTrel_C3_mc_raw = (TH2D*) H_pTrel_C3_MuJet_mc_raw->Clone("H_pTrel_C3_mc_raw");
  H_pTrel_C2_mc_raw = (TH2D*) H_pTrel_C2_MuJet_mc_raw->Clone("H_pTrel_C2_mc_raw");
  H_pTrel_C1_mc_raw = (TH2D*) H_pTrel_C1_MuJet_mc_raw->Clone("H_pTrel_C1_mc_raw");

  H_pTrel_C4_mc_smeared = (TH2D*) H_pTrel_C4_MuJet_mc_smeared->Clone("H_pTrel_C4_mc_smeared");
  H_pTrel_C3_mc_smeared = (TH2D*) H_pTrel_C3_MuJet_mc_smeared->Clone("H_pTrel_C3_mc_smeared");
  H_pTrel_C2_mc_smeared = (TH2D*) H_pTrel_C2_MuJet_mc_smeared->Clone("H_pTrel_C2_mc_smeared");
  H_pTrel_C1_mc_smeared = (TH2D*) H_pTrel_C1_MuJet_mc_smeared->Clone("H_pTrel_C1_mc_smeared");
  ...
  file_pp_data->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn",H_pTrel_pp_data);
  ...
  stylize_smeared(h_pTrel_pp_mc_smeared,h_pTrel_C4_mc_smeared,h_pTrel_C3_mc_smeared,h_pTrel_C2_mc_smeared,h_pTrel_C1_mc_smeared);
  ...
  leg_pp->AddEntry(h_pTrel_pp_mc_raw,"PYTHIA w/ JER smear","p");
  ...
  leg_C4->AddEntry(h_pTrel_C4_mc_smeared,"P+H 50-80% w/ jet-axis smear","p");
  ...
  r_pp->GetXaxis()->SetTitle("muon #it{p}_{T}^{rel} [GeV]");
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,5,1);
  canv_pp->SaveAs(Form("./figures/jetAxisSmearingEffectMuonPtRel/pp_%3.0fto%3.0f.pdf",jetPt_low,jetPt_high));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,5,1);
  canv_C4->SaveAs(Form("./figures/jetAxisSmearingEffectMuonPtRel/C4_%3.0fto%3.0f.pdf",jetPt_low,jetPt_high));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,5,1);
  canv_C3->SaveAs(Form("./figures/jetAxisSmearingEffectMuonPtRel/C3_%3.0fto%3.0f.pdf",jetPt_low,jetPt_high));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,5,1);
  canv_C2->SaveAs(Form("./figures/jetAxisSmearingEffectMuonPtRel/C2_%3.0fto%3.0f.pdf",jetPt_low,jetPt_high));
  ...
  li->SetLineStyle(7);
  li->DrawLine(0,1,5,1);
  canv_C1->SaveAs(Form("./figures/jetAxisSmearingEffectMuonPtRel/C1_%3.0fto%3.0f.pdf",jetPt_low,jetPt_high));
  ...
  // r_R->GetXaxis()->SetTitle("#it{b}-jet muon #it{p}_{T}^{rel} [GeV]");
