...
#include "plotJetTrkMaxDR_jetAxisSmearingEffect.h"
...
void plotJetTrkMaxDR_jetAxisSmearingEffect(int j = 1){
  ...
  // h_dR_pp_data = (TH1D*) H_dR_pp_data->ProjectionX("h_dR_pp_data",binFinder->FindBin(jetPt_low + smallShift),binFinder->FindBin(jetPt_high - smallShift));
  // h_dR_C5_data = (TH1D*) H_dR_C5_data->ProjectionX("h_dR_C5_data",binFinder->FindBin(jetPt_low + smallShift),binFinder->FindBin(jetPt_high - smallShift));
  // h_dR_C4_data = (TH1D*) H_dR_C4_data->ProjectionX("h_dR_C4_data",binFinder->FindBin(jetPt_low + smallShift),binFinder->FindBin(jetPt_high - smallShift));
  // h_dR_C3_data = (TH1D*) H_dR_C3_data->ProjectionX("h_dR_C3_data",binFinder->FindBin(jetPt_low + smallShift),binFinder->FindBin(jetPt_high - smallShift));
  // h_dR_C2_data = (TH1D*) H_dR_C2_data->ProjectionX("h_dR_C2_data",binFinder->FindBin(jetPt_low + smallShift),binFinder->FindBin(jetPt_high - smallShift));
  // h_dR_C1_data = (TH1D*) H_dR_C1_data->ProjectionX("h_dR_C1_data",binFinder->FindBin(jetPt_low + smallShift),binFinder->FindBin(jetPt_high - smallShift));
  ...
  r_pp = (TH1D*) h_dR_pp_mc_smeared->Clone("r_pp");
  r_C5 = (TH1D*) h_dR_C5_mc_smeared->Clone("r_C5");
  r_C4 = (TH1D*) h_dR_C4_mc_smeared->Clone("r_C4");
  r_C3 = (TH1D*) h_dR_C3_mc_smeared->Clone("r_C3");
  r_C2 = (TH1D*) h_dR_C2_mc_smeared->Clone("r_C2");
  r_C1 = (TH1D*) h_dR_C1_mc_smeared->Clone("r_C1");

  r_pp->Divide(h_dR_pp_mc_smeared,h_dR_pp_mc_raw,1,1,"B");
  r_C5->Divide(h_dR_C5_mc_smeared,h_dR_C5_mc_raw,1,1,"B");
  r_C4->Divide(h_dR_C4_mc_smeared,h_dR_C4_mc_raw,1,1,"B");
  r_C3->Divide(h_dR_C3_mc_smeared,h_dR_C3_mc_raw,1,1,"B");
  r_C2->Divide(h_dR_C2_mc_smeared,h_dR_C2_mc_raw,1,1,"B");
  r_C1->Divide(h_dR_C1_mc_smeared,h_dR_C1_mc_raw,1,1,"B");
  ...
  h_dR_pp_mc_raw->GetYaxis()->SetRangeUser(0,0.15);
  h_dR_pp_mc_raw->Draw();
  ...
  h_dR_C5_mc_raw->GetYaxis()->SetRangeUser(0,0.15);
  h_dR_C5_mc_raw->Draw();
  ...
  h_dR_C4_mc_raw->GetYaxis()->SetRangeUser(0,0.15);
  h_dR_C4_mc_raw->Draw();
  ...
  h_dR_C3_mc_raw->GetYaxis()->SetRangeUser(0,0.15);
  h_dR_C3_mc_raw->Draw();
  ...
  h_dR_C2_mc_raw->GetYaxis()->SetRangeUser(0,0.15);
  h_dR_C2_mc_raw->Draw();
  ...
  h_dR_C1_mc_raw->GetYaxis()->SetRangeUser(0,0.15);
  h_dR_C1_mc_raw->Draw();
  ...
  // h_dR_R_mc_raw->GetYaxis()->SetTitle("1/#it{N} d#it{N}/d#DeltaR");
  // h_dR_R_mc_raw->GetYaxis()->SetRangeUser(0,0.15);
  // h_dR_R_mc_raw->Draw();
  // h_dR_R_mc_smeared->Draw("same");
  // leg_R->Draw();
  // la->DrawLatexNDC(0.12,0.92,CMSString);
  // la->DrawLatexNDC(0.74,0.92,energyString);
  // la->DrawLatexNDC(0.4,0.8,jetPtString);
