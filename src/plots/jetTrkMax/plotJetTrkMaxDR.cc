...
void plotJetTrkMaxDR(int j = 1){
  ...
  h_dR_pp_mc_raw->GetYaxis()->SetRangeUser(0,0.25);
  h_dR_pp_mc_raw->Draw();
  ...
  h_dR_C5_mc_raw->GetYaxis()->SetRangeUser(0,0.25);
  h_dR_C5_mc_raw->Draw();
  ...
  la->DrawLatexNDC(0.4,0.7,hadronPtString);
  pad_C5_2->cd();
  r_C5->GetYaxis()->SetTitle("Weighted / Raw  ");
  ...
  h_dR_C4_mc_raw->GetYaxis()->SetRangeUser(0,0.25);
  h_dR_C4_mc_raw->Draw();
  ...
  h_dR_C3_mc_raw->GetYaxis()->SetRangeUser(0,0.25);
  h_dR_C3_mc_raw->Draw();
  ...
  h_dR_C2_mc_raw->GetYaxis()->SetRangeUser(0,0.25);
  h_dR_C2_mc_raw->Draw();
  ...
  h_dR_C1_mc_raw->GetYaxis()->SetRangeUser(0,0.25);
  h_dR_C1_mc_raw->Draw();
  ...
  // h_dR_R_mc_raw->GetYaxis()->SetRangeUser(0,0.25);
  // h_dR_R_mc_raw->Draw();
  ...
  // la->DrawLatexNDC(0.4,0.7,hadronPtString);
  // pad_R_2->cd();
  // r_R->GetYaxis()->SetTitle("Weighted / Raw  ");
