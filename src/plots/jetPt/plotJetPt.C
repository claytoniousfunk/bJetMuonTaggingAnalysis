...
void plotJetPt(bool isPP = 1, bool isC2 = 0, bool isC1 = 0, bool isSingleMuon = 1, bool isMinBias = 0, bool isMu7 = 0, bool isMu12 = 1){
   ...
   if(isPP){
	 ...
	 f1 = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/pp/final/pp_SingleMuon_mu12_tight_pTmu-14_projectableTemplates.root");
       ...
       f1 = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/pp/final/pp_MinBias_mu12_tight_pTmu-14_projectableTemplates.root");
     }
     else{};
     ...
     if(isMu7){
       ...
       f2 = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/golden/PYTHIA_DiJet_withGS_scan_mu12_tight_pTmu-14_pThat-15_removeHYDJETjets_leadingXjetDump.root");
     }
     else{};
