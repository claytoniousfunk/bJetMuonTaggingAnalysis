...
void plotJetPt_fineCentBins_MCVMC(bool isPP = 1,
				  bool isC4 = 0,
				  bool isC3 = 0,
				  bool isC2 = 0,
				  bool isC1 = 0){
  ...
  if(isPP){
    ...
    f1->GetObject("h_inclRecoJetPt_inclRecoMuonTag_triggerOn_flavor_C4",H1);
    f2->GetObject("h_inclRecoJetPt_flavor_C4",H2);
  }
  else if(isC3){
    f1->GetObject("h_inclRecoJetPt_inclRecoMuonTag_triggerOn_flavor_C3",H1);
    f2->GetObject("h_inclRecoJetPt_flavor_C3",H2);
  }
  else if(isC2){
    f1->GetObject("h_inclRecoJetPt_inclRecoMuonTag_triggerOn_flavor_C2",H1);
  ...
  if(isPP){
    leg->AddEntry(h1r,"PYTHIA #it{#mu}-tagged","p");
    leg->AddEntry(h2r,"PYTHIA inclusive","p");
  }

  else{
    leg->AddEntry(h1r,"PYTHIA+HYDJET #it{#mu}-tagged","p");
    leg->AddEntry(h2r,"PYTHIA+HYDJET inclusive","p");
  }
