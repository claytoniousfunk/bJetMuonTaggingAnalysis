...
void plotJetPt_fineCentBins_DataVData(bool isPP = 1,
				      bool isC4 = 0,
				      bool isC3 = 0,
				      bool isC2 = 0,
				      bool isC1 = 0){
  ...
  if(isPP){
    ...
    f2 = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PbPb/final/PbPb_MinBias_scan_mu12_tight_pTmu-14_hiHFcut_fineCentBins_projectableTemplates.root");
  ...
  if(isPP){
    ...
    leg->AddEntry(h2r,"pp MinBias","p");
  }

  else{
    leg->AddEntry(h1r,"PbPb SingleMuon","p");
    leg->AddEntry(h2r,"PbPb MinBias","p");
  }
