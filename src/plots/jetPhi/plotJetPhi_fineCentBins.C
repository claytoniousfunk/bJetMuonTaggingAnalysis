...
void plotJetPhi_fineCentBins(bool isPP = 1,
			     bool isC4 = 0,
			     bool isC3 = 0,
			     bool isC2 = 0,
			     bool isC1 = 0,
  ...
  if(isPP){
    ...
    if(isSingleMuon){
      ...
      //f1 = TFile::Open(goldenFile_PbPb_SingleMuon_mu12);
    ...
    //f2 = TFile::Open(goldenFile_PYTHIAHYDJET_DiJet_pThat20_mu12);
  ...
  if(isPP){
    if(isSingleMuon){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn",H2);
    }
    else if(isMinBias || isHardProbes){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi",H2);
    }
    else{};
  }
    ...
    if(isSingleMuon){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn_C4",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn_C4",H2);
    }
    else if(isMinBias){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_C4",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_C4",H2);
    }
    else{};
  }
    ...
    if(isSingleMuon){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn_C3",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn_C3",H2);
    }
    else if(isMinBias){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_C3",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_C3",H2);
    }
    else{};
  }
    ...
    if(isSingleMuon){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn_C2",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn_C2",H2);
    }
    else if(isMinBias){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_C2",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_C2",H2);
    }
    else{};
  }
    ...
    if(isSingleMuon){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn_C1",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_inclRecoMuonTag_triggerOn_C1",H2);
    }
    else if(isMinBias){
      f1->GetObject("h_inclRecoJetPt_inclRecoJetPhi_C1",H1);
      f2->GetObject("h_inclRecoJetPt_inclRecoJetPhi_C1",H2);
    }
    else{};
  }
  ...
  h1r->GetYaxis()->SetTitle("1/#it{N}^{jet} d#it{N}^{jet}/d#it{#phi}^{jet}");
  h1r->SetStats(0);
  ...
  r1->GetXaxis()->SetTitle("#it{#phi}^{jet}");
  ...
  h1r->GetYaxis()->SetRangeUser(0.00,0.65);
  h1r->Draw();
  h2r->Draw("same");
  ...
  if(isPP){
    if(isSingleMuon){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/SingleMuon/pp/jetPhi_SingleMuon_pp_mu12.pdf");
    }
    if(isMinBias){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/MinBias/pp/jetPhi_MinBias_pp_mu12.pdf");
    }
  }

  else if(isC4){
    if(isSingleMuon){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/SingleMuon/C4/jetPhi_SingleMuon_C4_mu12.pdf");
    }
    if(isMinBias){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/MinBias/C4/jetPhi_MinBias_C4_mu12.pdf");
    }
  }

  else if(isC3){
    if(isSingleMuon){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/SingleMuon/C3/jetPhi_SingleMuon_C3_mu12.pdf");
    }
    if(isMinBias){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/MinBias/C3/jetPhi_MinBias_C3_mu12.pdf");
    }
  }

  else if(isC2){
    if(isSingleMuon){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/SingleMuon/C2/jetPhi_SingleMuon_C2_mu12.pdf");
    }
    if(isMinBias){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/MinBias/C2/jetPhi_MinBias_C2_mu12.pdf");
    }
  }

  else if(isC1){
    if(isSingleMuon){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/SingleMuon/C1/jetPhi_SingleMuon_C1_mu12.pdf");
    }
    if(isMinBias){
      c1->SaveAs("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/jetPhi/MinBias/C1/jetPhi_MinBias_C1_mu12.pdf");
    }
  }
