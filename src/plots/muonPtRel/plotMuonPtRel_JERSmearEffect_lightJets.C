...
void plotMuonPtRel_JERSmearEffect_lightJets(bool isPP = 1,
					    bool isC4 = 0,
					    bool isC3 = 0,
					    bool isC2 = 0,
					    bool isC1 = 0,
   ...
   TH2D *H1, *H2;
   TH2D *H1_add, *H1_add2, *H1_add3;
   TH2D *H2_add, *H2_add2, *H2_add3;
   ...
   if(isPP){
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_T1",H1);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_T1",H1_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_T1",H1_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_T1",H1_add3);
     
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_T0",H2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_T0",H2_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_T0",H2_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_T0",H2_add3);
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_C4T1",H1);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_C4T1",H1_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_C4T1",H1_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_C4T1",H1_add3);
     
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_C4T0",H2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_C4T0",H2_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_C4T0",H2_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_C4T0",H2_add3);
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_C3T1",H1);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_C3T1",H1_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_C3T1",H1_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_C3T1",H1_add3);
     
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_C3T0",H2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_C3T0",H2_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_C3T0",H2_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_C3T0",H2_add3);
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_C2T1",H1);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_C2T1",H1_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_C2T1",H1_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_C2T1",H1_add3);
     
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_C2T0",H2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_C2T0",H2_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_C2T0",H2_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_C2T0",H2_add3);
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_C1T1",H1);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_C1T1",H1_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_C1T1",H1_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_C1T1",H1_add3);
     
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_C1T0",H2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_C1T0",H2_add);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_C1T0",H2_add2);
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_C1T0",H2_add3);
