...
void plotMuonPtRel(bool isPP = 1,
		   bool isC2 = 0,
		   bool isC1 = 0,
		   bool isSingleMuon = 1,
		   bool isMinBias = 0,
   ...
   if(isPP){
	 ...
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_J2",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_J2",H2);
       }
       else if(isJ3){
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_J3",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_J3",H2);
       }
       else if(isJ4){
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_J4",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_J4",H2);
       }
       else if(isJ5){
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_J5",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_J5",H2);
       }
       else if(isJ6){
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_J6",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_J6",H2);
       }
       else{};
     }
     else{};
   ...
   if(isC2){
	 ...
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_C1J2",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_C1J2",H2);
       }
       else if(isJ3){
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_C1J3",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_C1J3",H2);
       }
       else if(isJ4){
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_C1J4",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_C1J4",H2);
       }
       else if(isJ5){
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_C1J5",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_C1J5",H2);
       }
       else if(isJ6){
	 f1->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_C1J6",h1);
	 f2->GetObject("h_muptrel_inclRecoMuonTag_triggerOn_flavor_C1J6",H2);
       }
       else{};
     }
     else{};
