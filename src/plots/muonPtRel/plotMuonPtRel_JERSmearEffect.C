...
void plotMuonPtRel_JERSmearEffect(bool isPP = 1,
				  bool isC4 = 0,
				  bool isC3 = 0,
				  bool isC2 = 0,
				  bool isC1 = 0,
   ...
   if(isPP){
     ...
     f2 = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/PYTHIAHYDJET_DiJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_2025-11-4.root");
   ...
   if(isPP){
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_T1",H1);
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_C4T1",H1);
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_C3T1",H1);
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_C2T1",H1);
     ...
     f1->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_C1T1",H1);
