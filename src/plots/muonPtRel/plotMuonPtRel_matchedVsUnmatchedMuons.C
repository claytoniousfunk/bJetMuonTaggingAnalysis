...
void plotMuonPtRel_matchedVsUnmatchedMuons(double jetPtLow = 80,
					   double jetPtHigh = 500){


  TString jetPtSuffix = getJetPtString(jetPtLow,jetPtHigh);
  
  TFile *f_PY = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/latest/PYTHIA_DiJet_pThat-30_mu12_pTmu-15to999_tight_jetTrkMaxFilter_removeHYDJETjet0p35CutOnGen_2026-2-19.root");
  ...
  f_PY->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_allJets_T0",H_incl_allJets);
  f_PY->GetObject("h_muptrel_recoJetPt_matchedRecoMuonTag_triggerOn_allJets_T0",H_matched_allJets);
  f_PY->GetObject("h_muptrel_recoJetPt_unmatchedRecoMuonTag_triggerOn_allJets_T0",H_unmatched_allJets);

  f_PY->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_T0",H_incl_bJets);
  f_PY->GetObject("h_muptrel_recoJetPt_matchedRecoMuonTag_triggerOn_bJets_T0",H_matched_bJets);
  f_PY->GetObject("h_muptrel_recoJetPt_unmatchedRecoMuonTag_triggerOn_bJets_T0",H_unmatched_bJets);

  f_PY->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_T0",H_incl_bGSJets);
  f_PY->GetObject("h_muptrel_recoJetPt_matchedRecoMuonTag_triggerOn_bGSJets_T0",H_matched_bGSJets);
  f_PY->GetObject("h_muptrel_recoJetPt_unmatchedRecoMuonTag_triggerOn_bGSJets_T0",H_unmatched_bGSJets);

  f_PY->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_uJets_T0",H_incl_uJets);
  f_PY->GetObject("h_muptrel_recoJetPt_matchedRecoMuonTag_triggerOn_uJets_T0",H_matched_uJets);
  f_PY->GetObject("h_muptrel_recoJetPt_unmatchedRecoMuonTag_triggerOn_uJets_T0",H_unmatched_uJets);

  f_PY->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_dJets_T0",H_incl_dJets);
  f_PY->GetObject("h_muptrel_recoJetPt_matchedRecoMuonTag_triggerOn_dJets_T0",H_matched_dJets);
  f_PY->GetObject("h_muptrel_recoJetPt_unmatchedRecoMuonTag_triggerOn_dJets_T0",H_unmatched_dJets);

  f_PY->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_sJets_T0",H_incl_sJets);
  f_PY->GetObject("h_muptrel_recoJetPt_matchedRecoMuonTag_triggerOn_sJets_T0",H_matched_sJets);
  f_PY->GetObject("h_muptrel_recoJetPt_unmatchedRecoMuonTag_triggerOn_sJets_T0",H_unmatched_sJets);

  f_PY->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_gJets_T0",H_incl_gJets);
  f_PY->GetObject("h_muptrel_recoJetPt_matchedRecoMuonTag_triggerOn_gJets_T0",H_matched_gJets);
  f_PY->GetObject("h_muptrel_recoJetPt_unmatchedRecoMuonTag_triggerOn_gJets_T0",H_unmatched_gJets);
  ...
  h_incl_allJets->SetTitle("PYTHIA, all jets");
  ...
  canv_allJets->SaveAs(Form("../../../figures/muonPtRel/matchedVsUnmatchedMuons/muonPtRel_matchedVsUnmatchedMuons_PYTHIA_allJets_%s.pdf",jetPtSuffix.Data()));
  ...
  h_matched_allJets->SetTitle("PYTHIA, all jets");
  ...
  canv_allJetsShape->SaveAs(Form("../../../figures/muonPtRel/matchedVsUnmatchedMuons/muonPtRelShape_matchedVsUnmatchedMuons_PYTHIA_allJets_%s.pdf",jetPtSuffix.Data()));
  ...
  h_incl_bJets->SetTitle("PYTHIA, #it{b}-jets");
  ...
  canv_bJets->SaveAs(Form("../../../figures/muonPtRel/matchedVsUnmatchedMuons/muonPtRel_matchedVsUnmatchedMuons_PYTHIA_bJets_%s.pdf",jetPtSuffix.Data()));
  ...
  h_matched_bJets->SetTitle("PYTHIA, #it{b}-jets");
  ...
  la->SetTextColor(kRed-4);
  la->DrawLatexNDC(0.4,0.56,"Unmatched muons");
  canv_bJetsShape->SaveAs(Form("../../../figures/muonPtRel/matchedVsUnmatchedMuons/muonPtRelShape_matchedVsUnmatchedMuons_PYTHIA_bJets_%s.pdf",jetPtSuffix.Data()));
  ...
  h_incl_uJets->SetTitle("PYTHIA, #it{udsg}-jets");
  ...
  canv_uJets->SaveAs(Form("../../../figures/muonPtRel/matchedVsUnmatchedMuons/muonPtRel_matchedVsUnmatchedMuons_PYTHIA_udsgJets_%s.pdf",jetPtSuffix.Data()));
  ...
  h_matched_uJets->SetTitle("PYTHIA, #it{udsg}-jets");
  ...
  la->SetTextColor(kRed-4);
  la->DrawLatexNDC(0.4,0.56,"Unmatched muons");
  canv_uJetsShape->SaveAs(Form("../../../figures/muonPtRel/matchedVsUnmatchedMuons/muonPtRelShape_matchedVsUnmatchedMuons_PYTHIA_udsgJets_%s.pdf",jetPtSuffix.Data()));
  ...
  h_uJetsShapeRatio->SetTitle("PYTHIA, #it{udsg}-jets");
  ...
  canv_uJetsShapeRatio->SaveAs(Form("../../../figures/muonPtRel/matchedVsUnmatchedMuons/muonPtRelShapeRatio_matchedVsUnmatchedMuons_PYTHIA_udsgJets_%s.pdf",jetPtSuffix.Data()));
