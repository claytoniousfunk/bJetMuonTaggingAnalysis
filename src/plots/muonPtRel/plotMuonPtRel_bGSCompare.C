...
void plotMuonPtRel_bGSCompare(bool isPP = 1,
			      bool isC4 = 0,
			      bool isC3 = 0,
			      bool isC2 = 0,
			      bool isC1 = 0,
  ...
  if(isPP){
    ...
    f3 = TFile::Open(goldenFile_PYTHIAHYDJET_MuJet_pThat30_mu12_pTmu15_hiBinReweight_vzReweight);
    f4 = TFile::Open(goldenFile_PYTHIAHYDJET_BJet_pThat30_mu12_pTmu15_hiBinReweight_vzReweight);
  ...
  TH2D *H1, *H2, *H3, *H4;
  TH1D *h1, *h1_add, *h2, *h2_add, *h3, *h3_add, *h4;
  TH2D *M1, *M2; // muon-jet datasets
  TH2D *B1, *B2; // b-jet datasets
  TH1D *m1, *m2, *b1, *b2;


  if(isPP){
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_T0",H1);
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_T0",H2);
  }
  else if(isC4){
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C4T0",H1);
    f3->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C4T0",M1);
    f4->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C4T0",B1);
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C4T0",H2);
    f3->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C4T0",M2);
    f4->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C4T0",B2);
  }
  else if(isC3){
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C3T0",H1);
    f3->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C3T0",M1);
    f4->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C3T0",B1);
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C3T0",H2);
    f3->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C3T0",M2);
    f4->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C3T0",B2);
  }
  else if(isC2){
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C2T0",H1);
    f3->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C2T0",M1);
    f4->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C2T0",B1);
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C2T0",H2);
    f3->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C2T0",M2);
    f4->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C2T0",B2);
  }
  else if(isC1){
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C1T0",H1);
    f3->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C1T0",M1);
    f4->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bJets_C1T0",B1);
    f2->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C1T0",H2);
    f3->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C1T0",M2);
    f4->GetObject("h_muptrel_recoJetPt_inclRecoMuonTag_triggerOn_bGSJets_C1T0",B2);
  }
  else{};
  ...
  if(!isPP){
    m1 = (TH1D*) M1->ProjectionX("m1",binFinder->FindBin(jetPtMin+smallShift),binFinder->FindBin(jetPtMax-smallShift));
    b1 = (TH1D*) B1->ProjectionX("b1",binFinder->FindBin(jetPtMin+smallShift),binFinder->FindBin(jetPtMax-smallShift));
    m2 = (TH1D*) M2->ProjectionX("m2",binFinder->FindBin(jetPtMin+smallShift),binFinder->FindBin(jetPtMax-smallShift));
    b2 = (TH1D*) B2->ProjectionX("b2",binFinder->FindBin(jetPtMin+smallShift),binFinder->FindBin(jetPtMax-smallShift));
  ...
  if(isPP){
    if(isSingleMuon){
      leg->AddEntry(h1r,"nominal #it{b}-jets","p");
    }
    else if(isMinBias){
      leg->AddEntry(h1r,"pp MinBias","p");
    }
    else{};
    leg->AddEntry(h2r,"gluon-splitting #it{b}-jets","p");
  }
