...
void tagging_sequence_3CentBins(bool do_pp = 1,
				bool do_C3 = 0,
				bool do_C2 = 0,
				bool do_C1 = 0,
				bool do_mu5 = 0,
  ...
  if(do_C1) centrality_identifier = "_C1";
    ...
    centrality_identifier = "_C3";
    centrality_add_identifier = "_C4";
  }
  else{};
  ...
  else if(do_C3) la->DrawLatexNDC(0.2,0.92,"PYTHIA+HYDJET 30-90% 5.02 TeV");
  else{};
  la->SetTextFont(42);
  la->SetTextSize(0.042);
  ...
  c_spectra->SaveAs("./trig.png");
   ...
   if(do_pp){
     ...
     if(do_mu5) mf_png_save_string = "./matchingFactor_C3_mu5.png";
     else if(do_mu7) mf_png_save_string = "./matchingFactor_C3_mu7.png";
     else if(do_mu12) mf_png_save_string = "./matchingFactor_C3_mu12.png";
     else{}
   }
   else if(do_C2){
   ...
   if(do_pp){
     ...
     if(do_mu5) mf_file_save_string = "./matchingFactors/matchingFactor_C3_mu5.root";
     else if(do_mu7) mf_file_save_string = "./matchingFactors/matchingFactor_C3_mu7.root";
     else if(do_mu12) mf_file_save_string = "./matchingFactors/matchingFactor_C3_mu12.root";
     else{}
   }
   else if(do_C2){
   ...
   if(do_pp){
     ...
     if(do_mu5){
       ba_file_save_string = "./b_amplifiers/ba_C3_mu5.root";
       ba_sub_1_file_save_string = "./b_amplifiers/sub_amps/ba_sub_1_C3_mu5.root";
       ba_sub_2_file_save_string = "./b_amplifiers/sub_amps/ba_sub_2_C3_mu5.root";
       ba_sub_3_file_save_string = "./b_amplifiers/sub_amps/ba_sub_3_C3_mu5.root";
       ba_sub_4_file_save_string = "./b_amplifiers/sub_amps/ba_sub_4_C3_mu5.root";
     }
     else if(do_mu7){
       ba_file_save_string = "./b_amplifiers/ba_C3_mu7.root";
       ba_sub_1_file_save_string = "./b_amplifiers/sub_amps/ba_sub_1_C3_mu7.root";
       ba_sub_2_file_save_string = "./b_amplifiers/sub_amps/ba_sub_2_C3_mu7.root";
       ba_sub_3_file_save_string = "./b_amplifiers/sub_amps/ba_sub_3_C3_mu7.root";
       ba_sub_4_file_save_string = "./b_amplifiers/sub_amps/ba_sub_4_C3_mu7.root";
     }
     else if(do_mu12){
