...
void tagging_sequence_4CentBins(bool do_pp = 1,
				bool do_C4 = 0,
				bool do_C3 = 0,
				bool do_C2 = 0,
				bool do_C1 = 0){
  ...
  double new_axis[N_axis_edges] = {80,90,100,120,150,200,300};
  ...
  input_PYTHIAHYDJET_inclJets = "/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/response/PYTHIAHYDJET_response_DiJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_2025-9-19.root";
  input_PYTHIAHYDJET_inclJets_ResolutionSmear = "/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/response/PYTHIAHYDJET_response_DiJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_JERCorrection_2025-9-19.root";
  input_PYTHIAHYDJET_prime = "/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/response/PYTHIAHYDJET_response_DiJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_2025-9-19_muTaggedJets.root";
  input_PYTHIAHYDJET_EnergyShift = "/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/response/PYTHIAHYDJET_response_DiJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_BJetNeutrinoEnergyShift_2025-9-19_muTaggedJets.root";
  ...
  else if(do_C1 || do_C2 || do_C3 || do_C4){
  ...
  TH2D *HH_inclGen, *HH_inclReco, *HH_inclMuTag, *HH_genMuTag, *HH_matchedRecoMuTag, *HH_trig, *HH_trigp, *HH_shift, *HH_i, *HH_r;  // 2D histograms
  ...
  string centrality_add_identifier = "";
  if(do_C1) centrality_identifier = "_C1";
  else if(do_C2) centrality_identifier = "_C2";
  else if(do_C3) centrality_identifier = "_C3";
  else if(do_C4) centrality_identifier = "_C4";
  else{};
  ...
  std::cout << "H_trig->GetEntries() = " << H_trig->GetEntries() << "\n";
  ...
  std::cout << "b_trig->GetEntries() = " << b_trig->GetEntries() << "\n";
  std::cout << "b_trigp->GetEntries() = " << b_trigp->GetEntries() << "\n";

  std::cout << "r1->GetEntries() = " << r1->GetEntries() << "\n";
  std::cout << "r2->GetEntries() = " << r2->GetEntries() << "\n";
  std::cout << "r3->GetEntries() = " << r3->GetEntries() << "\n";
  std::cout << "r4->GetEntries() = " << r4->GetEntries() << "\n";
  std::cout << "r5->GetEntries() = " << r5->GetEntries() << "\n";
  std::cout << "r6->GetEntries() = " << r6->GetEntries() << "\n";
  std::cout << "r7->GetEntries() = " << r7->GetEntries() << "\n";
  ...
  else if(do_C1) la->DrawLatexNDC(0.2,0.92,"PYTHIA+HYDJET 0-10% 5.02 TeV");
  else if(do_C2) la->DrawLatexNDC(0.2,0.92,"PYTHIA+HYDJET 10-30% 5.02 TeV");
  else if(do_C3) la->DrawLatexNDC(0.2,0.92,"PYTHIA+HYDJET 30-50% 5.02 TeV");
  else if(do_C4) la->DrawLatexNDC(0.2,0.92,"PYTHIA+HYDJET 50-80% 5.02 TeV");
  else{};
  la->SetTextFont(42);
  la->SetTextSize(0.042);
  //la->DrawLatexNDC(0.25,0.28,"#hat{#font[52]{p}}_{T} > 30 GeV");
  la->DrawLatexNDC(0.25,0.2,"#font[52]{p}_{T}^{#mu} > 14 GeV");
  p_spectra_2->cd();
  r2->SetStats(0);
  r2->SetTitle("");
  ...
  if(do_pp){
    mf_png_save_string = "./matchingFactor_pp_mu12.png";
  }
  else if(do_C4){
    mf_png_save_string = "./matchingFactor_C4_mu12.png";
  }
  else if(do_C3){
    mf_png_save_string = "./matchingFactor_C3_mu12.png";
  }
  else if(do_C2){
    mf_png_save_string = "./matchingFactor_C2_mu12.png";
  }
  else if(do_C1){
    mf_png_save_string = "./matchingFactor_C1_mu12.png";
  }
  else{};
  ...
  if(do_pp){
    mf_file_save_string = "./matchingFactors/matchingFactor_pp_mu12.root";     
  }
  else if(do_C4){
    mf_file_save_string = "./matchingFactors/matchingFactor_C4_mu12.root";
  }
  else if(do_C3){
    mf_file_save_string = "./matchingFactors/matchingFactor_C3_mu12.root";
  }
  else if(do_C2){
    mf_file_save_string = "./matchingFactors/matchingFactor_C2_mu12.root";     
  }
  else if(do_C1){
    mf_file_save_string = "./matchingFactors/matchingFactor_C1_mu12.root";
  }
  else{};
  ...
  if(do_pp){
    ...
    ba_file_save_string = "./b_amplifiers/ba_C4_mu12_bJetNeutrinoEnergyShift.root";
    ba_sub_1_file_save_string = "./b_amplifiers/sub_amps/ba_sub_1_C4_mu12.root";
    ba_sub_2_file_save_string = "./b_amplifiers/sub_amps/ba_sub_2_C4_mu12.root";
    ba_sub_3_file_save_string = "./b_amplifiers/sub_amps/ba_sub_3_C4_mu12.root";
    ba_sub_4_file_save_string = "./b_amplifiers/sub_amps/ba_sub_4_C4_mu12.root";
  }
  else if(do_C3){
    ba_file_save_string = "./b_amplifiers/ba_C3_mu12_bJetNeutrinoEnergyShift.root";
    ba_sub_1_file_save_string = "./b_amplifiers/sub_amps/ba_sub_1_C3_mu12.root";
    ba_sub_2_file_save_string = "./b_amplifiers/sub_amps/ba_sub_2_C3_mu12.root";
    ba_sub_3_file_save_string = "./b_amplifiers/sub_amps/ba_sub_3_C3_mu12.root";
    ba_sub_4_file_save_string = "./b_amplifiers/sub_amps/ba_sub_4_C3_mu12.root";
  }
  else if(do_C2){
