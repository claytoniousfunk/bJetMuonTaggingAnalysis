			     ...
			     bool isMu12 = 1)
{
  ...
  if(isMu5){
    ...
    f_pythia = TFile::Open(goldenFile_PYTHIAHYDJET_DiJet_pThat30_mu5_RAW);
    ...
    f_pythia = TFile::Open(goldenFile_PYTHIAHYDJET_DiJet_pThat30_mu7_RAW);
    ...
    f_pythia = TFile::Open(goldenFile_PYTHIAHYDJET_DiJet_pThat30_mu12_RAW);
