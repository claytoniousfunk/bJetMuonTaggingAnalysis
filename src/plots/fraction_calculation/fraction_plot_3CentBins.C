...
void fraction_plot_3CentBins(bool do_mu5 = 0,
			     bool do_mu7 = 0,
			     bool do_mu12 = 1){
  ...
  */
  ...
  TH1D *y1, *y2, *y3, *y4;
  TH1D *yy1, *yy2, *yy3, *yy4;
  TH1D *yyy1, *yyy2, *yyy3, *yyy4;
  TH1D *yyyy1, *yyyy2, *yyyy3, *yyyy4;
  TH1D *yyyyy1, *yyyyy2, *yyyyy3, *yyyyy4;
  TH1D *b1, *b2, *b3, *b4;
  TH1D *b1_add, *b2_add, *b3_add, *b4_add;
  TH1D *b1_add2, *b2_add2, *b3_add2, *b4_add2;

  TH1D *bb1, *bb2, *bb3, *bb4;
  TH1D *bb1_add, *bb2_add, *bb3_add, *bb4_add;
  TH1D *bb1_add2, *bb2_add2, *bb3_add2, *bb4_add2;

  TH1D *bbb1, *bbb2, *bbb3, *bbb4;
  TH1D *bbb1_add, *bbb2_add, *bbb3_add, *bbb4_add;
  TH1D *bbb1_add2, *bbb2_add2, *bbb3_add2, *bbb4_add2;

  TH1D *bbbb1, *bbbb2, *bbbb3, *bbbb4;
  TH1D *bbbb1_add, *bbbb2_add, *bbbb3_add, *bbbb4_add;
  TH1D *bbbb1_add2, *bbbb2_add2, *bbbb3_add2, *bbbb4_add2;

  TH1D *bbbbb1, *bbbbb2, *bbbbb3, *bbbbb4;
  TH1D *bbbbb1_add, *bbbbb2_add, *bbbbb3_add, *bbbbb4_add;
  ...
  f1->GetObject("bFracResults_C3",h2);
  f1->GetObject("bFracResults_C2",h3);
  f1->GetObject("bFracResults_C1",h4);
  ...
  fb4->GetObject("r_corr",ba2);
  fb3->GetObject("r_corr",ba3);
  fb1->GetObject("r_corr",ba4);
