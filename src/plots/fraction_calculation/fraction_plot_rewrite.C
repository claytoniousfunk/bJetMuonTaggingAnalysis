...
void fraction_plot_rewrite(bool do_mu5 = 0,
			   bool do_mu7 = 0,
			   bool do_mu12 = 1){
  ...
  TFile *file_pp_MC, *file_PbPb_MC, *x3;
  file_pp_MC = TFile::Open(input_PYTHIA);
  file_PbPb_MC = TFile::Open(input_PYTHIAHYDJET);

  //TH2D *Y1, *Y2, *Y3;
  TH2D *H_inclRecoJetPt_pp, *H_inclRecoJetPt_C2, *H_inclRecoJetPt_C1;
  //TH1D *y1, *y2, *y3;
  TH1D *h_inclRecoJetPt_pp, *h_inclRecoJetPt_C2, *h_inclRecoJetPt_C1;
  // TH1D *b1, *b2, *b3;
  // TH1D *b1_add, *b2_add, *b3_add;
  // TH1D *b1_add2, *b2_add2, *b3_add2;
  TH1D *h_inclRecoBJetPt_pp, *h_inclRecoBJetPt_C2, *h_inclRecoBJetPt_C1;
  TH1D *h_inclRecoBBarJetPt_pp, *h_inclRecoBBarJetPt_C2, *h_inclRecoBBarJetPt_C1;
  TH1D *h_inclRecoBGSJetPt_pp, *h_inclRecoBGSJetPt_C2, *h_inclRecoBGSJetPt_C1;
  
  
  //TH2D *YY1, *YY2, *YY3;
  TH2D *H_inclRecoJetPt_inclGenMuonTag_pp, *H_inclRecoJetPt_inclGenMuonTag_C2, *H_inclRecoJetPt_inclGenMuonTag_C1;
  //TH1D *yy1, *yy2, *yy3;
  TH1D *h_inclRecoJetPt_inclGenMuonTag_pp, *h_inclRecoJetPt_inclGenMuonTag_C2, *h_inclRecoJetPt_inclGenMuonTag_C1;
  // TH1D *bb1, *bb2, *bb3;
  // TH1D *bb1_add, *bb2_add, *bb3_add;
  // TH1D *bb1_add2, *bb2_add2, *bb3_add2;
  TH1D *h_inclRecoBJetPt_inclGenMuonTag_pp, *h_inclRecoBJetPt_inclGenMuonTag_C2, *h_inclRecoBJetPt_inclGenMuonTag_C1;
  TH1D *h_inclRecoBBarJetPt_inclGenMuonTag_pp, *h_inclRecoBBarJetPt_inclGenMuonTag_C2, *h_inclRecoBBarJetPt_inclGenMuonTag_C1;
  TH1D *h_inclRecoBGSJetPt_inclGenMuonTag_pp, *h_inclRecoBGSJetPt_inclGenMuonTag_C2, *h_inclRecoBGSJetPt_inclGenMuonTag_C1;

  
  
  //TH2D *YYY1, *YYY2, *YYY3;
  TH2D *H_inclRecoJetPt_matchedRecoMuonTag_pp, *H_inclRecoJetPt_matchedRecoMuonTag_C2, *H_inclRecoJetPt_matchedRecoMuonTag_C1;
  //TH1D *yyy1, *yyy2, *yyy3;
  TH1D *h_inclRecoJetPt_matchedRecoMuonTag_pp, *h_inclRecoJetPt_matchedRecoMuonTag_C2, *h_inclRecoJetPt_matchedRecoMuonTag_C1;
  // TH1D *bbb1, *bbb2, *bbb3;
  // TH1D *bbb1_add, *bbb2_add, *bbb3_add;
  // TH1D *bbb1_add2, *bbb2_add2, *bbb3_add2;
  TH1D *h_inclRecoBJetPt_matchedRecoMuonTag_pp, *h_inclRecoBJetPt_matchedRecoMuonTag_C2, *h_inclRecoBJetPt_matchedRecoMuonTag_C1;
  TH1D *h_inclRecoBBarJetPt_matchedRecoMuonTag_pp, *h_inclRecoBBarJetPt_matchedRecoMuonTag_C2, *h_inclRecoBBarJetPt_matchedRecoMuonTag_C1;
  TH1D *h_inclRecoBGSJetPt_matchedRecoMuonTag_pp, *h_inclRecoBGSJetPt_matchedRecoMuonTag_C2, *h_inclRecoBGSJetPt_matchedRecoMuonTag_C1;
  

  
  
  //TH2D *YYYY1, *YYYY2, *YYYY3;
  TH2D *H_inclRecoJetPt_inclRecoMuonTag_pp, *H_inclRecoJetPt_inclRecoMuonTag_C2, *H_inclRecoJetPt_inclRecoMuonTag_C1;
  //TH1D *yyyy1, *yyyy2, *yyyy3;
  TH1D *h_inclRecoJetPt_inclRecoMuonTag_pp, *h_inclRecoJetPt_inclRecoMuonTag_C2, *h_inclRecoJetPt_inclRecoMuonTag_C1;
  // TH1D *bbbb1, *bbbb2, *bbbb3;
  // TH1D *bbbb1_add, *bbbb2_add, *bbbb3_add;
  // TH1D *bbbb1_add2, *bbbb2_add2, *bbbb3_add2;
  TH1D *h_inclRecoBJetPt_inclRecoMuonTag_pp, *h_inclRecoBJetPt_inclRecoMuonTag_C2, *h_inclRecoBJetPt_inclRecoMuonTag_C1;
  TH1D *h_inclRecoBBarJetPt_inclRecoMuonTag_pp, *h_inclRecoBBarJetPt_inclRecoMuonTag_C2, *h_inclRecoBBarJetPt_inclRecoMuonTag_C1;
  TH1D *h_inclRecoBGSJetPt_inclRecoMuonTag_pp, *h_inclRecoBGSJetPt_inclRecoMuonTag_C2, *h_inclRecoBGSJetPt_inclRecoMuonTag_C1;
  
  

  
  //TH2D *YYYYY1, *YYYYY2, *YYYYY3;
  TH2D *H_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp, *H_inclRecoJetPt_inclRecoMuonTag_triggerOn_C2, *H_inclRecoJetPt_inclRecoMuonTag_triggerOn_C1;
  //TH1D *yyyyy1, *yyyyy2, *yyyyy3;
  TH1D *h_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp, *h_inclRecoJetPt_inclRecoMuonTag_triggerOn_C2, *h_inclRecoJetPt_inclRecoMuonTag_triggerOn_C1;  
  // TH1D *bbbbb1, *bbbbb2, *bbbbb3;
  // TH1D *bbbbb1_add, *bbbbb2_add, *bbbbb3_add;
  // TH1D *bbbbb1_add2, *bbbbb2_add2, *bbbbb3_add2;
  TH1D *h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp, *h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_C2, *h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_C1;
  TH1D *h_inclRecoBBarJetPt_inclRecoMuonTag_triggerOn_pp, *h_inclRecoBBarJetPt_inclRecoMuonTag_triggerOn_C2, *h_inclRecoBBarJetPt_inclRecoMuonTag_triggerOn_C1;
  TH1D *h_inclRecoBGSJetPt_inclRecoMuonTag_triggerOn_pp, *h_inclRecoBGSJetPt_inclRecoMuonTag_triggerOn_C2, *h_inclRecoBGSJetPt_inclRecoMuonTag_triggerOn_C1;
  ...
  //TH2D *G;
  TH2D *H_inclGenJetPt_pp;
  TH1D *h_inclGenJetPt_pp, *h_inclGenBJetPt_pp, *h_inclGenBBarJetPt_pp, *h_inclGenBGSJetPt_pp;

  file_pp_MC->GetObject("h_inclRecoJetPt_flavor",H_inclRecoJetPt_pp);
  file_pp_MC->GetObject("h_inclGenJetPt_flavor",H_inclGenJetPt_pp);
  file_pp_MC->GetObject("h_inclRecoJetPt_inclGenMuonTag_flavor",H_inclRecoJetPt_inclGenMuonTag_pp);
  file_pp_MC->GetObject("h_inclRecoJetPt_matchedRecoMuonTag_flavor",H_inclRecoJetPt_matchedRecoMuonTag_pp);
  file_pp_MC->GetObject("h_inclRecoJetPt_inclRecoMuonTag_flavor",*H_inclRecoJetPt_inclRecoMuonTag_pp);
  file_pp_MC->GetObject("h_inclRecoJetPt_inclRecoMuonTag_triggerOn_flavor",H_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp);
  
  file_PbPb_MC->GetObject("h_inclRecoJetPt_flavor_C2",H_inclRecoJetPt_C2);
  file_PbPb_MC->GetObject("h_inclRecoJetPt_flavor_C1",H_inclRecoJetPt_C1);

  h_inclGenJetPt_pp = (TH1D*) H_inclGenJetPt_pp->ProjectionX();
  h_inclRecoJetPt_pp = (TH1D*) H_inclRecoJetPt_pp->ProjectionX();
  h_inclRecoJetPt_inclGenMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclGenMuonTag_pp->ProjectionX();
  h_inclRecoJetPt_matchedRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_matchedRecoMuonTag_pp->ProjectionX();
  h_inclRecoJetPt_inclRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclRecoMuonTag_pp->ProjectionX();
  h_inclRecoJetPt_inclRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclRecoMuonTag_pp->ProjectionX();


  h_inclRecoJetPt_C2 = (TH1D*) H_inclRecoJetPt_C2->ProjectionX();
  h_inclRecoJetPt_C1 = (TH1D*) H_inclRecoJetPt_C1->ProjectionX();

  TH1D *binFinder = H_inclRecoJetPt_pp->ProjectionY();
  double smallShift = 0.01;

  h_inclGenBBarJetPt_pp = (TH1D*) H_inclGenJetPt_pp->ProjectionX("h_inclGenBBarJetPt_pp",binFinder->FindBin(-5+smallShift),binFinder->FindBin(-4-smallShift));
  h_inclGenBJetPt_pp = (TH1D*) H_inclGenJetPt_pp->ProjectionX("h_inclGenBJetPt_pp",binFinder->FindBin(5+smallShift),binFinder->FindBin(6-smallShift));
  h_inclGenBGSJetPt_pp = (TH1D*) H_inclGenJetPt_pp->ProjectionX("h_inclGenBGSJetPt_pp",binFinder->FindBin(17.+smallShift),binFinder->FindBin(18.-smallShift));
  h_inclGenBJetPt_pp->Add(h_inclGenBBarJetPt_pp);
  h_inclGenBJetPt_pp->Add(h_inclGenBGSJetPt_pp);

  // genb->Add(genb_add);
  // genb->Add(genb_add2);
  
  h_inclRecoBBarJetPt_pp = (TH1D*) H_inclRecoJetPt_pp->ProjectionX("h_inclRecoBBarJetPt_pp",binFinder->FindBin(-5+smallShift),binFinder->FindBin(-4-smallShift));
  h_inclRecoBJetPt_pp = (TH1D*) H_inclRecoJetPt_pp->ProjectionX("h_inclRecoBJetPt_pp",binFinder->FindBin(5+smallShift),binFinder->FindBin(6-smallShift));
  h_inclRecoBGSJetPt_pp = (TH1D*) H_inclRecoJetPt_pp->ProjectionX("h_inclRecoBGSJetPt_pp",binFinder->FindBin(17.+smallShift),binFinder->FindBin(18.-smallShift));
  h_inclRecoBJetPt_pp->Add(h_inclRecoBBarJetPt_pp);
  h_inclRecoBJetPt_pp->Add(h_inclRecoBGSJetPt_pp);
  

  // b1->Add(b1_add);
  // b1->Add(b1_add2);

  h_inclRecoBBarJetPt_inclGenMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclGenMuonTag_pp->ProjectionX("h_inclRecoBBarJetPt_inclGenMuonTag_pp",binFinder->FindBin(-5+smallShift),binFinder->FindBin(-4-smallShift));
  h_inclRecoBJetPt_inclGenMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclGenMuonTag_pp->ProjectionX("h_inclRecoBJetPt_inclGenMuonTag_pp",binFinder->FindBin(5+smallShift),binFinder->FindBin(6-smallShift));
  h_inclRecoBGSJetPt_inclGenMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclGenMuonTag_pp->ProjectionX("h_inclRecoBGSJetPt_inclGenMuonTag_pp",binFinder->FindBin(17.+smallShift),binFinder->FindBin(18.-smallShift));
  h_inclRecoBJetPt_inclGenMuonTag_pp->Add(h_inclRecoBBarJetPt_inclGenMuonTag_pp);
  h_inclRecoBJetPt_inclGenMuonTag_pp->Add(h_inclRecoBGSJetPt_inclGenMuonTag_pp);
					  
  // bb1->Add(bb1_add);
  // bb1->Add(bb1_add2);

  h_inclRecoBBarJetPt_matchedRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_matchedRecoMuonTag_pp->ProjectionX("h_inclRecoBBarJetPt_matchedRecoMuonTag_pp",binFinder->FindBin(-5+smallShift),binFinder->FindBin(-4-smallShift));
  h_inclRecoBJetPt_matchedRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_matchedRecoMuonTag_pp->ProjectionX("h_inclRecoBJetPt_matchedRecoMuonTag_pp",binFinder->FindBin(5+smallShift),binFinder->FindBin(6-smallShift));
  h_inclRecoBGSJetPt_matchedRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_matchedRecoMuonTag_pp->ProjectionX("h_inclRecoBGSJetPt_matchedRecoMuonTag_pp",binFinder->FindBin(17.+smallShift),binFinder->FindBin(18.-smallShift));
  h_inclRecoBJetPt_matchedRecoMuonTag_pp->Add(h_inclRecoBBarJetPt_matchedRecoMuonTag_pp);
  h_inclRecoBJetPt_matchedRecoMuonTag_pp->Add(h_inclRecoBGSJetPt_matchedRecoMuonTag_pp);

  // bbb1->Add(bbb1_add);
  // bbb1->Add(bbb1_add2);

  h_inclRecoBBarJetPt_inclRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclRecoMuonTag_pp->ProjectionX("h_inclRecoBBarJetPt_inclRecoMuonTag_pp",binFinder->FindBin(-5+smallShift),binFinder->FindBin(-4-smallShift));
  h_inclRecoBJetPt_inclRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclRecoMuonTag_pp->ProjectionX("h_inclRecoBJetPt_inclRecoMuonTag_pp",binFinder->FindBin(5+smallShift),binFinder->FindBin(6-smallShift));
  h_inclRecoBGSJetPt_inclRecoMuonTag_pp = (TH1D*) H_inclRecoJetPt_inclRecoMuonTag_pp->ProjectionX("h_inclRecoBGSJetPt_inclRecoMuonTag_pp",binFinder->FindBin(17.+smallShift),binFinder->FindBin(18.-smallShift));
  h_inclRecoBJetPt_inclRecoMuonTag_pp->Add(h_inclRecoBBarJetPt_inclRecoMuonTag_pp);
  h_inclRecoBJetPt_inclRecoMuonTag_pp->Add(h_inclRecoBGSJetPt_inclRecoMuonTag_pp);

  // bbbb1->Add(bbbb1_add);
  // bbbb1->Add(bbbb1_add2);

  h_inclRecoBBarJetPt_inclRecoMuonTag_triggerOn_pp = (TH1D*) H_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp->ProjectionX("h_inclRecoBBarJetPt_inclRecoMuonTag_triggerOn_pp",binFinder->FindBin(-5+smallShift),binFinder->FindBin(-4-smallShift));
  h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp = (TH1D*) H_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp->ProjectionX("h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp",binFinder->FindBin(5+smallShift),binFinder->FindBin(6-smallShift));
  h_inclRecoBGSJetPt_inclRecoMuonTag_triggerOn_pp = (TH1D*) H_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp->ProjectionX("h_inclRecoBGSJetPt_inclRecoMuonTag_triggerOn_pp",binFinder->FindBin(17.+smallShift),binFinder->FindBin(18.-smallShift));
  h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp->Add(h_inclRecoBBarJetPt_inclRecoMuonTag_triggerOn_pp);
  h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp->Add(h_inclRecoBGSJetPt_inclRecoMuonTag_triggerOn_pp);
  ...
  h_inclRecoBBarJetPt_C2 = (TH1D*) H_inclRecoJetPt_C2->ProjectionX("h_inclRecoBBarJetPt_C2",binFinder->FindBin(-5+smallShift),binFinder->FindBin(-4-smallShift));
  h_inclRecoBJetPt_C2 = (TH1D*) H_inclRecoJetPt_C2->ProjectionX("h_inclRecoBJetPt_C2",binFinder->FindBin(5+smallShift),binFinder->FindBin(6-smallShift));
  h_inclRecoBGSJetPt_C2 = (TH1D*) H_inclRecoJetPt_C2->ProjectionX("h_inclRecoBGSJetPt_C2",binFinder->FindBin(17.+smallShift),binFinder->FindBin(18.-smallShift));
  h_inclRecoBJetPt_C2->Add(h_inclRecoBBarJetPt_C2);
  h_inclRecoBJetPt_C2->Add(h_inclRecoBGSJetPt_C2);

  h_inclRecoBBarJetPt_C1 = (TH1D*) H_inclRecoJetPt_C1->ProjectionX("h_inclRecoBBarJetPt_C1",binFinder->FindBin(-5+smallShift),binFinder->FindBin(-4-smallShift));
  h_inclRecoBJetPt_C1 = (TH1D*) H_inclRecoJetPt_C1->ProjectionX("h_inclRecoBJetPt_C1",binFinder->FindBin(5+smallShift),binFinder->FindBin(6-smallShift));
  h_inclRecoBGSJetPt_C1 = (TH1D*) H_inclRecoJetPt_C1->ProjectionX("h_inclRecoBGSJetPt_C1",binFinder->FindBin(17.+smallShift),binFinder->FindBin(18.-smallShift));
  h_inclRecoBJetPt_C1->Add(h_inclRecoBBarJetPt_C1);
  h_inclRecoBJetPt_C1->Add(h_inclRecoBGSJetPt_C1);
  ...
  TH1D *h_inclGenBJetPt_pp_R = (TH1D*) h_inclGenBJetPt_pp->Rebin(M-1,"h_inclGenBJetPt_pp_R",new_axis);
  divideByBinwidth(h_inclGenBJetPt_pp_R); h_inclGenBJetPt_pp_R->Scale(5.0);

  TH1D *h_inclGenJetPt_pp_R = (TH1D*) h_inclGenJetPt_pp->Rebin(M-1,"h_inclGenJetPt_pp_R",new_axis);
  divideByBinwidth(h_inclGenJetPt_pp_R); h_inclGenJetPt_pp_R->Scale(5.0);
  
  TH1D *h_inclRecoBJetPt_pp_R = (TH1D*) h_inclRecoBJetPt_pp->Rebin(M-1,"h_inclRecoBJetPt_pp_R",new_axis);
  divideByBinwidth(h_inclRecoBJetPt_pp_R); h_inclRecoBJetPt_pp_R->Scale(5.0);

  TH1D *h_inclRecoBJetPt_C2_R = (TH1D*) h_inclRecoBJetPt_C2->Rebin(M-1,"h_inclRecoBJetPt_C2_R",new_axis);
  divideByBinwidth(h_inclRecoBJetPt_C2_R); h_inclRecoBJetPt_C2_R->Scale(5.0);

  TH1D *h_inclRecoBJetPt_C1_R = (TH1D*) h_inclRecoBJetPt_C1->Rebin(M-1,"h_inclRecoBJetPt_C1_R",new_axis);
  divideByBinwidth(h_inclRecoBJetPt_C1_R); h_inclRecoBJetPt_C1_R->Scale(5.0); 
  
  TH1D *h_inclRecoBJetPt_inclGenMuonTag_pp_R = (TH1D*) h_inclRecoBJetPt_inclGenMuonTag_pp->Rebin(M-1,"h_inclRecoBJetPt_inclGenMuonTag_pp_R",new_axis);
  divideByBinwidth(h_inclRecoBJetPt_inclGenMuonTag_pp_R); h_inclRecoBJetPt_inclGenMuonTag_pp_R->Scale(5.0); 

  TH1D *h_inclRecoBJetPt_matchedRecoMuonTag_pp_R = (TH1D*) h_inclRecoBJetPt_matchedRecoMuonTag_pp->Rebin(M-1,"h_inclRecoBJetPt_matchedRecoMuonTag_pp_R",new_axis);
  divideByBinwidth(h_inclRecoBJetPt_matchedRecoMuonTag_pp_R); h_inclRecoBJetPt_matchedRecoMuonTag_pp_R->Scale(5.0);

  TH1D *h_inclRecoBJetPt_inclRecoMuonTag_pp_R = (TH1D*) h_inclRecoBJetPt_inclRecoMuonTag_pp->Rebin(M-1,"h_inclRecoBJetPt_inclRecoMuonTag_pp_R",new_axis);
  divideByBinwidth(h_inclRecoBJetPt_inclRecoMuonTag_pp_R); h_inclRecoBJetPt_inclRecoMuonTag_pp_R->Scale(5.0);

  TH1D *h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp_R = (TH1D*) h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp->Rebin(M-1,"h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp_R",new_axis);
  divideByBinwidth(h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp_R); h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp_R->Scale(5.0);

  TH1D *h_inclRecoJetPt_pp_R = (TH1D*) h_inclRecoJetPt_pp->Rebin(M-1,"h_inclRecoJetPt_pp_R",new_axis);
  divideByBinwidth(h_inclRecoJetPt_pp_R); h_inclRecoJetPt_pp_R->Scale(5.0);

  TH1D *h_inclRecoJetPt_C2_R = (TH1D*) h_inclRecoJetPt_C2->Rebin(M-1,"h_inclRecoJetPt_C2_R",new_axis);
  divideByBinwidth(h_inclRecoJetPt_C2_R); h_inclRecoJetPt_C2_R->Scale(5.0);

  TH1D *h_inclRecoJetPt_C1_R = (TH1D*) h_inclRecoJetPt_C1->Rebin(M-1,"h_inclRecoJetPt_C1_R",new_axis);
  divideByBinwidth(h_inclRecoJetPt_C1_R); h_inclRecoJetPt_C1_R->Scale(5.0);
  
  TH1D *h_inclRecoJetPt_inclGenMuonTag_pp_R = (TH1D*) h_inclRecoJetPt_inclGenMuonTag_pp->Rebin(M-1,"h_inclRecoJetPt_inclGenMuonTag_pp_R",new_axis);
  divideByBinwidth(h_inclRecoJetPt_inclGenMuonTag_pp_R); h_inclRecoJetPt_inclGenMuonTag_pp_R->Scale(5.0); 

  TH1D *h_inclRecoJetPt_matchedRecoMuonTag_pp_R = (TH1D*) h_inclRecoJetPt_matchedRecoMuonTag_pp->Rebin(M-1,"h_inclRecoJetPt_matchedRecoMuonTag_pp_R",new_axis);
  divideByBinwidth(h_inclRecoJetPt_matchedRecoMuonTag_pp_R); h_inclRecoJetPt_matchedRecoMuonTag_pp_R->Scale(5.0);

  TH1D *h_inclRecoJetPt_inclRecoMuonTag_pp_R = (TH1D*) h_inclRecoJetPt_inclRecoMuonTag_pp->Rebin(M-1,"h_inclRecoJetPt_inclRecoMuonTag_pp_R",new_axis);
  divideByBinwidth(h_inclRecoJetPt_inclRecoMuonTag_pp_R); h_inclRecoJetPt_inclRecoMuonTag_pp_R->Scale(5.0);

  TH1D *h_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp_R = (TH1D*) h_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp->Rebin(M-1,"h_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp_R",new_axis);
  divideByBinwidth(h_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp_R); h_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp_R->Scale(5.0); 
  

  TH1D *b_truth_gen = (TH1D*) h_inclGenBJetPt_pp->Clone("b_truth_gen");
  b_truth_gen->Divide(h_inclGenBJetPt_pp,h_inclGenJetPt_pp,1,1,"B");

  TH1D *b_truth_gen_R = (TH1D*) h_inclGenBJetPt_pp_R->Clone("b_truth_gen_R");
  b_truth_gen_R->Divide(h_inclGenBJetPt_pp_R,h_inclGenJetPt_pp_R,1,1,"B");
  
  TH1D *b_truth_pp = (TH1D*) h_inclRecoBJetPt_pp->Clone("b_truth_pp");
  b_truth_pp->Divide(h_inclRecoBJetPt_pp,h_inclRecoJetPt_pp,1,1,"B");

  TH1D *b_truth_pp_R = (TH1D*) h_inclRecoBJetPt_pp_R->Clone("b_truth_pp_R");
  b_truth_pp_R->Divide(h_inclRecoBJetPt_pp_R,h_inclRecoJetPt_pp_R,1,1,"B");

  TH1D *b_truth_pp_inclGenMuTag_R = (TH1D*) h_inclRecoBJetPt_inclGenMuonTag_pp_R->Clone("b_truth_pp_inclGenMuTag_R");
  b_truth_pp_inclGenMuTag_R->Divide(h_inclRecoBJetPt_inclGenMuonTag_pp_R,h_inclRecoJetPt_inclGenMuonTag_pp_R,1,1,"B");

  TH1D *b_truth_pp_matchedRecoMuTag_R = (TH1D*) h_inclRecoBJetPt_matchedRecoMuonTag_pp_R->Clone("b_truth_pp_matchedRecoMuTag_R");
  b_truth_pp_matchedRecoMuTag_R->Divide(h_inclRecoBJetPt_matchedRecoMuonTag_pp_R,h_inclRecoJetPt_matchedRecoMuonTag_pp_R,1,1,"B");

  TH1D *b_truth_pp_inclRecoMuTag_R = (TH1D*) h_inclRecoBJetPt_inclRecoMuonTag_pp_R->Clone("b_truth_pp_inclRecoMuTag_R");
  b_truth_pp_inclRecoMuTag_R->Divide(h_inclRecoBJetPt_inclRecoMuonTag_pp_R,h_inclRecoJetPt_inclRecoMuonTag_pp_R,1,1,"B");

  TH1D *b_truth_pp_inclRecoMuTag_triggerOn_R = (TH1D*) h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp_R->Clone("b_truth_pp_inclRecoMuTag_triggerOn_R");
  b_truth_pp_inclRecoMuTag_triggerOn_R->Divide(h_inclRecoBJetPt_inclRecoMuonTag_triggerOn_pp_R,h_inclRecoJetPt_inclRecoMuonTag_triggerOn_pp_R,1,1,"B");

 
  
  
  
  TH1D *b_truth_C2 = (TH1D*) h_inclRecoBJetPt_C2->Clone("b_truth_C2");
  b_truth_C2->Divide(h_inclRecoBJetPt_C2,h_inclRecoJetPt_C2,1,1,"B");

  TH1D *b_truth_C2_R = (TH1D*) h_inclRecoBJetPt_C2_R->Clone("b_truth_C2_R");
  b_truth_C2_R->Divide(h_inclRecoBJetPt_C2_R,h_inclRecoJetPt_C2_R,1,1,"B");

  TH1D *b_truth_C1 = (TH1D*) h_inclRecoBJetPt_C1->Clone("b_truth_C1");
  b_truth_C1->Divide(h_inclRecoBJetPt_C1,h_inclRecoJetPt_C1,1,1,"B");

  TH1D *b_truth_C1_R = (TH1D*) h_inclRecoBJetPt_C1_R->Clone("b_truth_C1_R");
  b_truth_C1_R->Divide(h_inclRecoBJetPt_C1_R,h_inclRecoJetPt_C1_R,1,1,"B");
