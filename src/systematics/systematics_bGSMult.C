...
void systematics_bGSMult(){
  ...
  // pp ranges
  const int N_bGS_input_pp_J2 = 9;
  double bGS_input_pp_J2[N_bGS_input_pp_J2] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};

  const int N_bGS_input_pp_J3 = 9;
  double bGS_input_pp_J3[N_bGS_input_pp_J3] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};

  const int N_bGS_input_pp_J4 = 9;
  double bGS_input_pp_J4[N_bGS_input_pp_J4] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};

  // C2 ranges
  const int N_bGS_input_C2_J2 = 9;
  double bGS_input_C2_J2[N_bGS_input_C2_J2] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};

  const int N_bGS_input_C2_J3 = 9;
  double bGS_input_C2_J3[N_bGS_input_C2_J3] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};
  
  const int N_bGS_input_C2_J4 = 9;
  double bGS_input_C2_J4[N_bGS_input_C2_J4] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};

  // C1 ranges
  const int N_bGS_input_C1_J2 = 9;
  double bGS_input_C1_J2[N_bGS_input_C1_J2] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};

  const int N_bGS_input_C1_J3 = 9;
  double bGS_input_C1_J3[N_bGS_input_C1_J3] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};
  
  const int N_bGS_input_C1_J4 = 9;
  double bGS_input_C1_J4[N_bGS_input_C1_J4] = {1.0,1.05,1.1,1.15,1.2,1.25,1.3,1.35,1.4};
  ...
  //   bGS_input_pp_J4[i] = bGS_input_pp_J2[i] + small_shift;
  ...
  // if(do_mu5 == 1) pp_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/pp_mu5.pdf";
  // else if(do_mu7 == 1) pp_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/pp_mu7.pdf";
  // else if(do_mu12 == 1) pp_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/pp_mu12.pdf";
  // else{};
  ...
  // if(do_mu5 == 1) C2_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/C2_mu5.pdf";
  // else if(do_mu7 == 1) C2_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/C2_mu7.pdf";
  // else if(do_mu12 == 1) C2_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/C2_mu12.pdf";
  // else{};
  // la->SetTextSize(0.032);
  // la->SetTextColor(kBlue-4);
  ...
  double nominal_result_C1_J4 = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_multiplier , bGS_multiplier, 1);
  double nominal_err_C1_J4 = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_multiplier , bGS_multiplier, 2);
  
  for(int i = 0; i < N_bGS_input_C1_J4; i++){

    //    zeros_C1_J4[i] = 0.0;
    double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_multiplier , bGS_input_C1_J4[i], 1);
    double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_multiplier , bGS_input_C1_J4[i], 2);
  ...
  if(do_mu5 == 1) C1_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/C1_mu5.pdf";
  else if(do_mu7 == 1) C1_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/C1_mu7.pdf";
  else if(do_mu12 == 1) C1_canv_save_string = "/home/clayton/Analysis/ANDraft/figures/systematics/bGS-multiplier/C1_mu12.pdf";
  else{};
  la->SetTextSize(0.032);
  la->SetTextColor(kBlue-4);
