...
void systematics_JEUShiftUp_spectraEffect(bool doPP = 1,
					  bool doC4 = 0,
					  bool doC3 = 0,
					  bool doC2 = 0,
					  bool doC1 = 0){
  ...
  TFile *f_pp_incl_smear = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/latest/response/PYTHIA_DiJet_response_pThat-20_mu12_pTmu-14_tight_vzReweight_jetPtReweight_jetTrkMaxFilter_removeHYDJETjet0p45_applyJEUShiftUp_2025-9-30.root");
  ...
  TFile *f_pp_muTagged_smear = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIA/latest/response/PYTHIA_DiJet_response_pThat-20_mu12_pTmu-14_tight_vzReweight_jetPtReweight_jetTrkMaxFilter_removeHYDJETjet0p45_applyJEUShiftUp_2025-9-30_muTaggedJets.root");
  ...
  TFile *f_PbPb_incl_smear = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/scanningOutput/PYTHIAHYDJET/latest/response/PYTHIAHYDJET_response_DiJet_pThat-20_mu12_pTmu-14_tight_hiBinReweight_hiBinShift-10_jetTrkMaxFilter_removeHYDJETjet0p45_applyJEUShiftUp_2025-10-6.root");
...
if(doPP){
  ...
  canv_F->SaveAs(Form("../../figures/systematics/JEU-shift-up-spectra/muTaggedFraction_%s.pdf",canv_suffix.c_str()));
  canv_delta->SaveAs(Form("../../figures/systematics/JEU-shift-up-spectra/delta_%s.pdf",canv_suffix.c_str()));

  auto wf = TFile::Open(Form("../../rootFiles/systematics/JEU-shift-up-spectra/histograms_%s.root",canv_suffix.c_str()),"recreate");
  F_pp_nom->Write();
  F_pp_smear->Write();
  delta->Write();
  wf->Close();
