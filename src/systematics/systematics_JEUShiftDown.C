...
void systematics_JEUShiftDown(bool do_mu5 = 0,
			      bool do_mu7 = 0,
			      bool do_mu12 = 1){
  ...
  cout << endl;
  cout << "#######  SYSTEMATICS -- JEU Shift DOWN  #########" << endl;
  cout << endl;
  ...
  file_b_smear = TFile::Open("/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/rootFiles/bPurityResults/latest/bPurityResults_DATA-1_mergeB-1_mergeC-1_pTrel-0.0to5.0_cMult-1.0_bMult-1.175_JERsmear-0_JEUShiftUp-0_JEUShiftDown-1_bJetEnergyShift-0.root");
  ...
  pp_canv_save_string = "/home/clayton/Analysis/code/bJetMuonTaggingAnalysis/figures/systematics/JEU-shift-down/JEU-shift-down.pdf";
  ...
  la->DrawLatexNDC(0.22, 0.77, "JEU Shift Down systematic");
