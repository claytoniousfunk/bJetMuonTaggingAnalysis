...
void systematics_cMult(){
  ...
  // pp ranges
  const int N_c_input_pp_J1 = 9;
  const int N_c_input_pp_J2 = 9;
  double c_input_pp_J1[N_c_input_pp_J2] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};
  double c_input_pp_J2[N_c_input_pp_J2] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  const int N_c_input_pp_J3 = 9;
  double c_input_pp_J3[N_c_input_pp_J3] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  const int N_c_input_pp_J4 = 9;
  double c_input_pp_J4[N_c_input_pp_J4] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  const int N_c_input_pp_J5 = 9;
  double c_input_pp_J5[N_c_input_pp_J5] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  const int N_c_input_pp_J6 = 9;
  double c_input_pp_J6[N_c_input_pp_J6] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  // C2 ranges
  const int N_c_input_C2_J1 = 9;
  const int N_c_input_C2_J2 = 9;
  double c_input_C2_J1[N_c_input_C2_J2] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};
  ...
  double c_input_C2_J5[N_c_input_C2_J5] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  const int N_c_input_C2_J6 = 9;
  double c_input_C2_J6[N_c_input_C2_J6] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  // C1 ranges
  const int N_c_input_C1_J1 = 9;
  const int N_c_input_C1_J2 = 9;
  double c_input_C1_J1[N_c_input_C1_J2] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};
  double c_input_C1_J2[N_c_input_C1_J2] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  const int N_c_input_C1_J3 = 9;
  double c_input_C1_J3[N_c_input_C1_J3] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};
  ...
  double c_input_C1_J5[N_c_input_C1_J5] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};

  const int N_c_input_C1_J6 = 9;
  double c_input_C1_J6[N_c_input_C1_J6] = {0.8,0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2};  
  ...
  //   //    zeros_pp_J2[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  1,0,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J2[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  1,0,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J2[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_pp_J2[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,1,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J2[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,1,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J2[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_pp_J3[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,0,1,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J3[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,0,1,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J3[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_pp_J4[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J4[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J4[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_pp_J5[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,0,0,0,1,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J5[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,0,0,0,1,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J5[i] , bGS_multiplier, 2);
    

  //   c_input_pp_J5[i] = c_input_pp_J2[i] + small_shift;
  ...
  //   //    zeros_pp_J6[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,0,0,0,0,1,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J6[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  1,0,0,  0,0,0,0,0,1,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_pp_J6[i] , bGS_multiplier, 2);
    

  //   c_input_pp_J6[i] = c_input_pp_J2[i] + small_shift;
  ...
  // if(do_mu5 == 1) pp_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/pp_mu5.pdf";
  // else if(do_mu7 == 1) pp_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/pp_mu7.pdf";
  // else if(do_mu12 == 1) pp_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/pp_mu12.pdf";
  // else{};
  ...
  //   //    zeros_C2_J2[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  1,0,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J1[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  1,0,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J1[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_C2_J2[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,1,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J2[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,1,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J2[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_C2_J3[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,0,1,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J3[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,0,1,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J3[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_C2_J4[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J4[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J4[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_C2_J5[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,0,0,0,1,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J5[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,0,0,0,1,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J5[i] , bGS_multiplier, 2);
  ...
  //   //    zeros_C2_J6[i] = 0.0;
  //   double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,0,0,0,0,1,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J6[i] , bGS_multiplier, 1);
  //   double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,0,1,  0,0,0,0,0,1,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C2_J6[i] , bGS_multiplier, 2);
  ...
  // if(do_mu5 == 1) C2_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/C2_mu5.pdf";
  // else if(do_mu7 == 1) C2_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/C2_mu7.pdf";
  // else if(do_mu12 == 1) C2_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/C2_mu12.pdf";
  // else{};
  // la->SetTextSize(0.032);
  // la->SetTextColor(kBlack);
  ...
  for(int i = 0; i < N_c_input_C1_J1; i++){
    ...
    //    zeros_C1_J1[i] = 0.0;
    double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  1,0,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J1[i] , bGS_multiplier, 1);
    double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  1,0,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J1[i] , bGS_multiplier, 2);
  ...
  for(int i = 0; i < N_c_input_C1_J2; i++){
    ...
    //    zeros_C1_J2[i] = 0.0;
    double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,1,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J2[i] , bGS_multiplier, 1);
    double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,1,0,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J2[i] , bGS_multiplier, 2);
  ...
  for(int i = 0; i < N_c_input_C1_J3; i++){
    ...
    //    zeros_C1_J3[i] = 0.0;
    double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,1,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J3[i] , bGS_multiplier, 1);
    double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,1,0,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J3[i] , bGS_multiplier, 2);
  ...
  for(int i = 0; i < N_c_input_C1_J4; i++){
    ...
    //    zeros_C1_J4[i] = 0.0;
    double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J4[i] , bGS_multiplier, 1);
    double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,1,0,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J4[i] , bGS_multiplier, 2);
  ...
  for(int i = 0; i < N_c_input_C1_J5; i++){
    ...
    //    zeros_C1_J5[i] = 0.0;
    double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,0,1,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J5[i] , bGS_multiplier, 1);
    double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,0,1,0,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J5[i] , bGS_multiplier, 2);
  ...
  for(int i = 0; i < N_c_input_C1_J6; i++){
    ...
    //    zeros_C1_J6[i] = 0.0;
    double result_i  = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,0,0,1,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J6[i] , bGS_multiplier, 1);
    double err_i = templateFitter(do_data, do_mu5,do_mu7,do_mu12,  0,1,0,  0,0,0,0,0,1,  do_mergeB,do_mergeC,  do_2tempFit,do_3tempFit,  pTrel_fit_low,pTrel_fit_high, c_input_C1_J6[i] , bGS_multiplier, 2);
  ...
  gr_C1_J5->SetLineColor(kMagenta-2);
  ...
  if(do_mu5 == 1) C1_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/C1_mu5.pdf";
  else if(do_mu7 == 1) C1_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/C1_mu7.pdf";
  else if(do_mu12 == 1) C1_canv_save_string = "/home/clayton/Analysis/HIN-23-008/figures/systematics/c-multiplier/C1_mu12.pdf";
  else{};
  la->SetTextSize(0.032);
  la->SetTextColor(kBlack);
